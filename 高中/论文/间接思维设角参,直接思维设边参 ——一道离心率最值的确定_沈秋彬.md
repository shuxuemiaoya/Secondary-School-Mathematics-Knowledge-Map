...
![](images/d1683bb066aeda0c1c8447f16c266f25ba71c569cb1beefda60b00ce6094fd90.jpg)
...
合椭圆中相关点的确定与角的构建,利用 $\cos\angle F_{1}AB$ 取值的最小值来设置条件,进而确定此时对应椭圆的离心率的值.合理的创设,巧妙将平面解析几何与解三角形、三角函数等相关知识加以融合,实现知识的交汇与能力的综合.
...
由 $b = \sqrt{2} c$ ，得 $e = \frac{c}{a} = \sqrt{\frac{c^2}{2c^2 + c^2}} = \frac{\sqrt{3}}{3}$
...
故 $\frac{(2a - m)^2 + m^2 - 4c^2}{2m(2a - m)} = \frac{(2a - m)^2 + (a + m)^2 - a^2}{2(2a - m)(a + m)}$ 整理可得 $m = \frac{a(a^2 - c^2)}{a^2 + c^2}$ .
...
$2\sqrt{\frac{2}{9}(3e^{2} + 1)\times\frac{\frac{8}{9}}{3e^{2} + 1}} -\frac{1}{9} = \frac{7}{9}$ ，当且仅当 $\frac{2}{9}\times$
...
$\frac{\frac{9}{4}a^{2}+\frac{1}{4}a^{2}-4c^{2}}{2\times\frac{3}{4}a^{2}}=\frac{7}{9}$ ，整理得 $a^{2}=3c^{2}$ .
