...
> <center>
> 
> | ![](images/dfb0c56c66fa253b35e4238d80742048a0ecf02157cf6b613b96c67bf9053c2e.jpg) | ![](images/a6b3c10063f0ead084f5e13aaa22c3899e29ebc44c62999188d369dab309b30c.jpg) |
> | --- | --- |
> | （5）如图所示，在 $\triangle ABC$ 中， $D$ ， $F$ 分别是 $AB$ ， $AC$ 的中点， $BF$ 与 $CD$ 交于点 $O$ ，设 $\overrightarrow{AB}=\boldsymbol{a}$ ， $\overrightarrow{AC}=\boldsymbol{b}$ ，向量 $\overrightarrow{AO}=\lambda\boldsymbol{a}+\mu\boldsymbol{b}$ ，则 $\lambda+\mu$ 的值为\_\_\_\_. | （6）如图, 在平行四边形 $ABCD$ 中, $AC$ , $BD$ 相交于点 $O$ , $E$ 为线段 $AO$ 的中点. 若 $\overrightarrow{BE} = \lambda \overrightarrow{BA} + \mu \overrightarrow{BD} (\lambda, \mu \in \mathbf{R})$ , 则 $\lambda + \mu$ 等于 ( ) |
> </center>
...
> <center>
> 
> | ![](images/2f90ac8533f3a00555cef67e569b4cc1f6767f367f2b6ab27cc7496c3fb3da84.jpg) | ![](images/ec999deab3136148d8b62f31c9ac2bf58382d9f7ad3df1fbd3d17a9b40648849.jpg) |
> | --- | --- |
> | （4）在直角梯形 ABCD 中， $AB \perp AD$ ，AD = DC = 1，AB = 3，动点 P 在以点 C 为圆心，且与直线 BD 相切的圆内运动，设 $\overrightarrow{AP} = x\overrightarrow{AB} + y\overrightarrow{AD}(x, y \in \mathbb{R})$ ，则 $x + y$ 的取值范围是 \_\_\_\_. | （5）如图, 在平行四边形 $ABCD$ 中, $M$ , $N$ 为 $CD$ 的三等分点, $S$ 为 $AM$ 与 $BN$ 的交点, $P$ 为边 $AB$ 上一动点, $Q$ 为三角形 $SMN$ 内一点 (含边界), 若 $\overrightarrow{PQ} = x\overrightarrow{AM} + y\overrightarrow{BN}(x, y \in \mathbf{R})$ , 则 $x + y$ 的取值范围是 \_\_\_\_. |
> </center>
...
> <center>
> 
> | ![](images/50b34dde205d56c1e1633ef36c5c02eb7ea4ae9aad31321e033b47d511f2487c.jpg) | ![](images/fe70cbc02d53b50b1033950b0f9bd15df8b3f299bcd59cbcf4576b92a4c8f652.jpg) | ![](images/2244bf5131b08d0a82dc2fa9e4e1b29e48262dd19133d094f140a2fe93781ded.jpg) |
> | --- | --- | --- |
> | （7）如图所示, $A$ , $B$ , $C$ 是圆 $O$ 上的三点, 线段 $CO$ 的延长线与 $BA$ 的延长线交于圆 $O$ 外的一点 $D$ , 若 $\overrightarrow{OC} = m\overrightarrow{OA} + n\overrightarrow{OB}$ , 则 $m + n$ 的取值范围是 \_\_\_\_. | （8）已知点 O 为△ABC 的边 AB 的中点，D 为边 BC 的三等分点，DC=2DB，P 为△ADC 内(包括边界)任一点，若 $\overrightarrow{OP}=x\overrightarrow{OB}+y\overrightarrow{OD}$ ，则 x-2y 的取值范围为 \_\_\_\_. | （9）如图, 在边长为 1 的正方形 $ABCD$ 中, $E$ 为 $AB$ 的中点, $P$ 为以 $A$ 为圆心, $AB$ 为半径的圆弧 (在正方形内, 包括边界点) 上的任意一点, 若向量 $\overrightarrow{AC} = \lambda \overrightarrow{DE} + \mu \overrightarrow{AP}$ , 则 $\lambda + \mu$ 的最小值为 \_\_\_\_. |
> </center>
