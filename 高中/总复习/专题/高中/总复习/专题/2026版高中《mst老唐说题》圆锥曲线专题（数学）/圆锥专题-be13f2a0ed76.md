...
Portrait of a woman in a pink blazer sitting at a desk, writing on paper (no visible text or symbols)
</details>
...
第十一届中国2012年 Korean Academic Division
第十二届 Korean Academic Division
第十三届 Korean Academic Division
第十四届 Korean Academic Division
第十五届 Korean Academic Division
第十六届 Korean Academic Division
第十七届 Korean Academic Division
第十八届 Korean Academic Division
第十九届 Korean Academic Division
第二十届 Korean Academic Division
第二十一届 Korean Academic Division
第二十二届 Korean Academic Division
第二十三届 Korean Academic Division
第二十四届 Korean Academic Division
第二十五届 Korean Academic Division
第二十六届 Korean Academic Division
第二十七届 Korean Academic Division
第二十八届 Korean Academic Division
第二十九届 Korean Academic Division
第三十届 Korean Academic Division
第三十一届 Korean Academic Division
第三十二届 Korean Academic Division
第三十三届 Korean Academic Division
第三十四届 Korean Academic Division
第三十五届 Korean Academic Division
第三十六届 Korean Academic Division
第三十七届 Korean Academic Division
第三十八届 Korean Academic Division
第三十九届 Korean Academic Division
第四十届 Korean Academic Division
第四十一届 Korean Academic Division
第四十二届 Korean Academic Division
第四十三届 Korean Academic Division
第四十四届 Korean Academic Division
第四十五届 Korean Academic Division
第四十六届 Korean Academic Division
第四十七届 Korean Academic Division
第四十八届 Korean Academic Division
第四十九届 Korean Academic Division
第五十届 Korean Academic Division
第五十一届 Korean Academic Division
第五十二届 Korean Academic Division
第五十三届 Korean Academic Division
第五十四届 Korean Academic Division
第五十五届 Korean Academic Division
第五十六届 Korean Academic Division
第五十七届 Korean Academic Division
第五十八届 Korean Academic Division
第五十九届 Korean Academic Division
第六十届 Korean Academic Division
第六十一届 Korean Academic Division
第六十二届 Korean Academic Division
第六十三届 Korean Academic Division
第六十四届 Korean Academic Division
第六十五届 Korean Academic Division
第六十六届 Korean Academic Division
第六十七届 Korean Academic Division
第六十八届 Korean Academic Division
第六十九届 Korean Academic Division
第七十届 Korean Academic Division
第七十一届 Korean Academic Division
第七十二届 Korean Academic Division
第七十三届 Korean Academic Division
第七十四届 Korean Academic Division
第七十五届 Korean Academic Division
第七十六届 Korean Academic Division
第七十七届 Korean Academic Division
第七十八届 Korean Academic Division
第七十九届 Korean Academic Division
第八十届 Korean Academic Division
第八十一届 Korean Academic Division
第八十二届 Korean Academic Division
第八十三届 Korean Academic Division
第八十四届 Korean Academic Division
第八十五届 Korean Academic Division
第八十六届 Korean Academic Division
第八十七届 Korean Academic Division
第八十八届 Korean Academic Division
第八十九届 Korean Academic Division
</details>
...
Classroom scene with students seated at desks facing a presentation screen; visible Chinese text on screen and presentation slide in background
</details>
...
Classroom scene with students seated facing a projection screen displaying Chinese text and a small diagram, likely for an academic or educational presentation.
</details>
...
Conference hall photo with visible presentation screen showing Chinese text and date information
</details>
...
(2)将等轴双曲线 $x^{2} - y^{2} = 9$ 逆时针旋转 $\frac{\pi}{4}$ , 记原双曲线上任意一点 $P_{n}: (x_{n}, y_{n})$ 满足: $z_{P_{n}} = x_{n} + y_{n}\mathrm{i}$ , 作复数逆时针旋转 $\frac{\pi}{4}$ 得到 $Z_{P_{n}^{\prime}} = x_{n}^{\prime} + y_{n}^{\prime}\mathrm{i}$ , 则: $Z_{P_{n}^{\prime}} = (x_{n} + y_{n}\mathrm{i})(\cos \frac{\pi}{4} + \mathrm{i}\sin \frac{\pi}{4}) = \frac{\sqrt{2}}{2}(x_{n} - y_{n}) + \frac{\sqrt{2}}{2}(x_{n} + y_{n})\mathrm{i}$ , 故 $\left\{ \begin{array}{l} x_{n}^{\prime} = \frac{\sqrt{2}}{2}(x_{n} - y_{n}) \\ y_{n}^{\prime} = \frac{\sqrt{2}}{2}(x_{n} + y_{n}) \end{array} \right.$ , 由于 $x_{n}^{2} - y_{n}^{2} = 9$ , 故 $x_{n}^{\prime}y_{n}^{\prime} = \frac{1}{2}(x_{n}^{2} - y_{n}^{2}) = \frac{9}{2}$ , 本题仅需证 $\frac{x_n^{\prime}}{x_{n-1}^{\prime}}$ 为定值, 由于 $Q_{n-1}$ 与 $P_{n}$ 关于 $y$ 轴对称, 故 $Q_{n-1}^{\prime}$ 与 $P_{n}^{\prime}$ 关于 $y = -x$ 对称, 且新坐标系 $k^{\prime} = \frac{1 + k}{1 - k}(0 < k < 1)$ , 记 $P_{n-1}^{\prime}(x_{n-1}^{\prime}, y_{n-1}^{\prime}), P_{n}^{\prime}(x_{n}^{\prime}, y_{n}^{\prime})$ , 则 $Q_{n-1}^{\prime}(-y_{n}^{\prime}, -x_{n}^{\prime}), k^{\prime} = k_{P_{n-1}^{\prime}Q_{n-1}^{\prime}} = \frac{\frac{9}{2x_{n-1}^{\prime}} + \frac{9}{2y_{n}^{\prime}}}{x_{n-1}^{\prime} + y_{n}^{\prime}} = \frac{9}{2x_{n-1}^{\prime}y_{n}^{\prime}} = \frac{x_{n}^{\prime}}{x_{n-1}^{\prime}}$ , 故 $\frac{x_n - y_n}{x_{n-1} - y_{n-1}} = \frac{1 + k}{1 - k}$
...
所以 $k_{P'_{n}P'_{n+3}} = -\frac{9}{2x'_{n+3}x'_{n}}$ ， $k_{P'_{n+1}P'_{n+2}} = -\frac{9}{2x'_{n+2}x'_{n+1}}$ ，由于 $\{x'_{n}\}$ 是等比数列，故 $x'_{n}x'_{n+3} = x'_{n+1}x'_{n+2}$ ，故 $k_{P'_{n}P'_{n+3}} = k_{P'_{n+1}P'_{n+2}}$ 。
...
(2)(3)令 $\left\{\begin{aligned}x^{\prime}_{n}&=\frac{x_{n}}{\sqrt{3}}-\frac{y_{n}}{2\sqrt{3}}=\frac{1}{\sqrt{2}}\left(\frac{\sqrt{2}x_{n}}{\sqrt{3}}-\frac{y_{n}}{\sqrt{6}}\right)\\ y^{\prime}_{n}&=\frac{x_{n}}{\sqrt{3}}+\frac{y_{n}}{2\sqrt{3}}=\frac{1}{\sqrt{2}}\left(\frac{\sqrt{2}x_{n}}{\sqrt{3}}+\frac{y_{n}}{\sqrt{6}}\right)\end{aligned}\right.$ ，所以 $y^{\prime}_{n}=\frac{1}{x^{\prime}_{n}}$ ，设 $P^{\prime}_{n-1}(x^{\prime}_{n-1},y^{\prime}_{n-1})$ ， $P^{\prime}_{n}(x^{\prime}_{n},y^{\prime}_{n})$
...
(3)由(2)易得： $P^{\prime}_{n}\left(\frac{3^{n - 1}}{\sqrt{2}},\frac{3}{\sqrt{2}\cdot 3^{n - 1}}\right)$ ，则 $S_1^\prime = \frac{1}{2}|x_{n + 1}^\prime y_{n + 2} - x_{n + 2}^\prime y_{n + 1}^\prime | = \frac{1}{2}\left|\frac{3^n}{\sqrt{2}}\cdot \frac{3}{\sqrt{2}\cdot 3^{n + 1}} -\frac{3^{n + 1}}{\sqrt{2}}\cdot$ $\frac{3}{\sqrt{2}\cdot 3^n}\bigg| = 2,\quad S_2^\prime = \frac{1}{2}|x_G^\prime y_H^\prime -x_H^\prime y_G^\prime | = \frac{1}{2}\left|\frac{x_n^\prime + x_{n + 2}^\prime}{2}\cdot \frac{y_{n + 1}^\prime + y_{n + 3}^\prime}{2} -\frac{x_{n + 1}^\prime + x_{n + 3}^\prime}{2}\cdot \frac{y_n^\prime + y_{n + 2}^\prime}{2}\right| =$ $\frac{1}{2}\left|\frac{25}{18} -\frac{25}{2}\right| = \frac{50}{9}$ 故 $\frac{S_1^\prime}{S_2^\prime} = \frac{S_1}{S_2} = \frac{9}{25}.$
...
(1)在 $\frac{\pi}{4}$ 的旋转变换下, 若点 $P(1, 1)$ 变成 $P'$ 点, 直线 $l: y = 2x - 1$ 变成直线 $l'$ , 求: $P'$ 的坐标和直线 $l'$ 的斜率;
...
例2 (2025·河北张家口期末第18题)直线 $l$ 经过抛物线 $E: y^{2} = 4x$ 的焦点 $F$ , 且与 $E$ 交于 $A, B$ 两点 (点 $A$ 在 $x$ 轴上方), 点 $M_{n}(n, 0) (n \in \mathbf{N}^{*}, \text{且 } n \geqslant 2)$ 在 $x$ 轴上, 直线 $AM_{n}, BM_{n}$ 分别与 $E$ 交于点 $C_{n}, D_{n}$ , 记直线 $C_{n}D_{n}$ 与 $x$ 轴交点的横坐标为 $x_{n}$ .

(1)若直线 l 垂直于 x 轴，求直线 $C_{2}D_{2}$ 的方程.

(2)证明： $\sum_{i=2}^{n}\frac{1}{x_{i}}<\frac{3}{4}.$

解析 (1) 易知抛物线 $E$ 得焦点为 $F(1,0)$ , 若直线 $l$ 垂直于 $x$ 轴, 此时直线 $l$ 的方程为 $x=1$ , 将 $x=1$ 代入抛物线的方程中, 解得 $y=\pm2$ , 因为点 $A$ 在 $x$ 轴上方, 所以 $y_A=2, y_B=-2$ , 因为 $M_2(2,0)$ ,
...
例1（2025·北京清华附中高三开学）已知椭圆 $E: \frac{x^{2}}{a^{2}} + \frac{y^{2}}{b^{2}} = 1 (a > b > 0)$ ，其离心率 $e = \frac{\sqrt{5}}{3}$ ，长轴长为6.
...
此类型题太多，我们会在本书第二章介绍背景后更多此法。

# 三、对合方程简化斜率关系模型

例2 (2020·新课标 I)已知 A, B 分别为椭圆 $E: \frac{x^{2}}{a^{2}} + y^{2} = 1 (a > 1)$ 的左、右顶点，G 为 E 的上顶点， $\overrightarrow{AG} \cdot \overrightarrow{GB} = 8$ . P 为直线 x = 6 上的动点，PA 与 E 的另一交点为 M，PB 与 E 的另一交点为 N.
...
(2)(i)要证 $|P_1Q_1| = |P_2Q_2|$ ，只要证线段 $P_{1}P_{2}$ 的中点与线段 $Q_{1}Q_{2}$ 的中点重合。设 $P_{1}(x_{1},y_{1})$ ， $P_{2}(x_{2},y_{2})$ ，其中 $x_{1} < 0 < x_{2}$ ，由条件，直线 $l$ 的斜率存在，设 $l$ 的方程为 $y = kx + m$ 。因为直线 $l$ 与圆 $x^{2} + y^{2} = 3$ 相切，所以 $\frac{|m|}{\sqrt{1 + k^2}} = \sqrt{3}$ ，即 $m^{2} = 3(1 + k^{2})$ 。联立 $\left\{ \begin{array}{l} y = kx + m \\ \frac{x^{2}}{3} - y^{2} = 1 \end{array} \right.$ ， $(3k^{2} - 1)x^{2} + 6kmx + (3m^{2} + 3) = 0$ ，
...
![](images/chunk_000_dd2d1f2ad8af8b01ff52e22ee4a004eb2ff5ef68a0e2ce6ea1af8b40341e4a85.jpg)
...
$Q\left(\frac{x_1 - \lambda x_2}{1 - \lambda},\frac{y_1 - \lambda y_2}{1 - \lambda}\right)$ ，有 $\left\{ \begin{array}{l} \frac{x_1^2}{a^2}\pm \frac{y_1^2}{b^2} = 1(1)\\ \frac{\lambda^2x_2^2}{a^2}\pm \frac{\lambda^2y_2^2}{b^2} = \lambda^2 (2) \end{array} \right.$
...
![](images/chunk_000_b0b7fac9456a1bd407e35346b6e6e96f764bfc5d1b0959642ce52b6cecb026f3.jpg)
...
证明: 如右图所示, 直线 $PN$ 为点 $M$ 对应的极线, 则 $(QM, AD) = -1$ , 又 $PQ \parallel RT$ , $\frac{TM}{PQ} = \frac{DM}{DQ} = \frac{AM}{AQ} = \frac{MR}{PQ}$ , 所以 $MT = MR$ .
...
令 DE 交 x 轴于 M(m, 0)， $\frac{y_{3}}{x_{3}-m}=\frac{y_{2}}{x_{2}-m}\Rightarrow\frac{\frac{y_{1}}{\mu}}{\frac{5}{2}-\frac{3}{2\mu}-m}=\frac{\frac{y_{1}}{-\lambda}}{\frac{5}{2}-\frac{3}{2\lambda}-m}\Rightarrow\frac{1}{\left(\frac{5}{2}-m\right)\mu-\frac{3}{2}}=\frac{1}{-\left(\frac{5}{2}-m\right)\lambda+\frac{3}{2}}$ ;
...
解法二(曲线系): 证明: 令 $\begin{array}{l}AD: x - k_{2}y - 1 = 0 \\ BE: x - k_{3}y - 1 = 0 \end{array}$ , 过二次曲线 $AB$ , $DE$ 与二次曲线 $AD$ , $BE$ 的四个交点
...
Geometric diagram with ellipse, circle, and shaded triangle in coordinate plane
</details>
...
书写过程(两点对合式): $k_{AB} = \frac{y_1 - y_2}{x_1 - x_2} = \frac{4(y_1 - y_2)}{y_1^2 - y_2^2} = \frac{4}{y_1 + y_2}$ , 故直线 $AB$ 方程为: $y - y_1 = \frac{4}{y_1 + y_2}$ $(x - \frac{y_1^2}{4})$ , 化简可得: $(y_1 + y_2)y = 4x + y_1y_2$ . 由于直线 $AB$ 过 $Q(0, 1)$ , 所以 $y_1 + y_2 = y_1y_2$
...
![](images/chunk_000_8b19ca1ece000562ca58b88506664c06c2eebca34e794d9ac4687ac8edf1f044.jpg)
...
![](images/chunk_000_94a2aabfd60202afc7cc54c05989bd474ee9ee1cfb74bcedea4a4a5d4fa4f2ac.jpg)
...
![](images/chunk_000_2c27621fb64d47076ae56c6739a4a149be49013c6712533de037d4f33dd6c4a6.jpg)
...
例3 设 $F$ 为椭圆 $C: \frac{x^2}{4} + \frac{y^2}{3} = 1$ 的右焦点, 不垂直于 $x$ 轴且不过点 $F$ 的直线 $l$ 与 $C$ 交于 $M$ , $N$ 两点,在 $\triangle MFN$ 中, 若 $\angle MFN$ 的外角平分线与直线 $MN$ 交于点 $P$ , 则 $P$ 的横坐标为
...
对合中心分析: 过 $A$ 作 $AS \parallel y$ 轴交椭圆于 $S(2, -2)$ , 过 $A$ 作斜率为 $\frac{1}{2}$ 直线, 即 $y = \frac{1}{2} x + 1$ 交椭圆于 $R\left(-\frac{10}{3}, -\frac{2}{3}\right)$ , 和 $S$ 均为不动点, 点 $S$ 处切线方程为 $\frac{2x}{12} + \frac{-2y}{6} = 1$ , 点 $R$ 处切线方程为 $\frac{-\frac{10}{3}x}{12} + \frac{-\frac{2}{3}y}{6} = 1$ , 根据极点极线极配可知, 联立 $\left\{ \begin{array}{l} \frac{2x_{P}}{12} + \frac{-2y_{P}}{6} = 1 \\ -\frac{10}{3}x_{P} + \frac{-\frac{2}{3}y_{P}}{6} = 1 \end{array} \right.$ 故对合中心为 $P(-2, -4)$ , 对合轴 $RS$ 方程为 $y = -\frac{x}{4} - \frac{3}{2}$ .
...
![](images/chunk_000_cca3200661758e4a12df641a2c181fb78f1d72f5d25ec39adb098d488175a748.jpg)
...
$\frac{4}{3} k_{OQ} = -\frac{1}{k}$ ， $k_{BN}(k_{AM} - k_{PR}) = k_2\left(k_1 + \frac{1}{k}\right) = 3k_1^2 +\frac{3k_1}{k} = 3k_1^2 -k_1(k_2 + k_3) = -k_1k_3 = \frac{3}{4}$ ，显然复杂的一些斜率关系，齐次化最好表达.
...
故在直线 MN 上一定存在点 Q，使得 $\overrightarrow{MQ} = -\lambda \overrightarrow{QN}$ （定比调和），此时 $\left\{\begin{aligned}\frac{x_{1}-\lambda x_{2}}{1-\lambda}&=x_{Q}\\ \frac{y_{1}-\lambda y_{2}}{1-\lambda}&=y_{Q}\end{aligned}\right.$
...
Geometric diagram of an ellipse with labeled points and lines, including triangle ABC and auxiliary points A', B', C'.
</details>
...
交叉相乘构造齐次化： $\left(\frac{x^2}{4} -y^2\right)[x(1 - x_0) + y(1 - y_0)] = (x^2 +y^2)\left(-\frac{xx_0}{4} +yy_0\right)$ ，同除以 $x^{3}$ 得： $-k^3$ $+\left(\frac{5x_0}{4} -1\right)k^2 +\left(\frac{1}{4} -\frac{5y_0}{4}\right)k + \frac{1}{4} = 0,\quad k_1kk_2 = -\frac{\frac{1}{4}}{-1} = \frac{1}{4}.$
...
![](images/chunk_000_51321efd1f2630a8c09992637b68f42acb08288891f458144c8a67d56ba0fd07.jpg)
...
分析点 $T$ ，就要结合底边在 $x$ 轴上得中点三角形ATB，如右图，则 $\frac{1}{k_1} +\frac{1}{k_4} = \frac{2}{k_{OT}} = -2$ ，所以 $k_{1} = -$ $\frac{k_4}{2k_4 + 1}$ ；综上， $k_{1}k_{2} = -\frac{k_{4}}{2k_{4} + 1}\left(\frac{1}{2} -k_{3}\right) = -\frac{\frac{1}{2}k_{4} + \frac{1}{4}}{2k_{4} + 1} = -\frac{1}{4}.$
...
(2)若直线 $OM$ 与椭圆 $\eta$ 的另外一个交点为 $S$ , 直线 $A_{1} S$ 与直线 $A_{2} N$ 相交于点 $P$ , 直线 $P O$ 与直线 $l$ 相交于点 $Q$ , 证明: 点 $Q$ 在一条定直线上, 并求出该定直线的方程.
...
再翻译 $P$ 点，根据底边在 $x$ 轴的中线三角形可得： $\frac{1}{k_3} +\frac{1}{k_4} = \frac{2}{k_{PQ}}$ ，所以 $k_{1} + k_{2} = -\frac{5}{9}\left(\frac{1}{k_{3}} +\frac{1}{k_{4}}\right) = -\frac{10}{9k_{PQ}}$
...
对称点为 $F'$ , 直线 $A_{1}E$ 与直线 $A_{2}F'$ 交于点 $M$ , 求证: 直线 $OM$ 与直线 $EF$ 的交点 $N$ 在定直线上.
...
![](images/chunk_000_9cb646d02b7aaebe3553ff1d12c1658283f35e86b56dc50dbe37f85210422b32.jpg)  
3 抛物线
...
仿射法定理二(面积伸缩定理): $\frac{S^{\prime}}{S} = \frac{a}{b}$ (拉伸短轴); $\frac{S^{\prime\prime}}{S} = \frac{b}{a}$ (压缩长轴)
...
由于 $C^{\prime}D^{\prime} / / A^{\prime}B^{\prime}$ ，故 $OF^{\prime}\bot C^{\prime}D^{\prime}$ ， $OF^{\prime}\bot A^{\prime}B^{\prime}$ ， $S_{\triangle F'M'N'} = \frac{1}{2}|M'N'|\cdot |OF'| = 6$ ， $S_{\triangle FMN} = 3\sqrt{2}$
...
![](images/chunk_000_3eae76a8c8812c4f70a8898208957c76519dac5c44dda1a0460bf4683ca121a7.jpg)
...
$f^{\prime}(\theta) = 9\cos 2\theta +9\cos \theta = 18\cos^{2}\theta +9\cos \theta -9 = 0$ ，即当 $\cos \theta = \frac{1}{2}$ 时， $S_{\triangle PAB\max} = \frac{27\sqrt{3}}{4}, d_{O - AB} = 3\cos \theta = \frac{3}{2},$
...
![](images/chunk_000_877900dd04a20935761eea2d5447ec06ae542e38533e1ed67867fb4bef1f54cf.jpg)
...
![](images/chunk_000_6821f0aa032445228f5bd95690bd9f2efbc8d968c43934e7daaf4f1617e95584.jpg)
...
![](images/chunk_000_27605d7648e1c7fae17b1889a0b2c956fa7cbbe00cc4f2b5432d305e4e1379b4.jpg)
...
则 $\left|OA\right|^{2}+\left|OA_{1}\right|^{2}=x_{0}^{2}+y_{0}^{2}+x_{1}^{2}+y_{1}^{2}=a^{2}+b^{2}$ ，故 $\left|OA\right|^{2}+\left|OA_{1}\right|^{2}$ 为定值，定值为 $a^{2}+b^{2}$ ;
...
例2 已知椭圆 $\frac{x^{2}}{3}+\frac{y^{2}}{2}=1$ 的左、右焦点分别为 $F_{1}$ 、 $F_{2}$ ，过 $F_{1}$ 的直线交椭圆于B、D两点，过 $F_{2}$ 的直线交椭圆于A、C两点，且 $AC\perp BD$ ，垂足为P．求四边形ABCD的面积的最小值.
...
![](images/chunk_000_2d774cd8e8436d9e5d1c2eb182da52f4045693b3f9787e12806b96cbd99f51a1.jpg)

<details>
<summary>text_image</summary>

Three mathematical diagrams showing coordinate systems with circles, parabolas, and tangent lines labeled with points A, B, C, D, E, F, O, and right angles.
</details>
...
我们以椭圆为例来表达线段长度，注意到 $|CD|=|FD|\sin\alpha,\quad|OD|=c-|FD|=c-\frac{e|AB|}{2}$
...
(2)设 $P(x_0,y_0)(x_0 > 0,y_0 > 0),Q_1(x_1,y_1),Q_2(x_2,y_2),$
...
把 $\frac{x_{0}^{2}}{12}+\frac{y_{0}^{2}}{3}=1\Rightarrow x_{0}^{2}+4y_{0}^{2}=12\quad\frac{x_{1}^{2}}{4}+y_{1}^{2}=1\Rightarrow x_{1}^{2}+4y_{1}^{2}=4$ 代入①
...
因此有 $x_{1}y_{2} - x_{2}y_{1} = 4(x_{1} - x_{2})\Rightarrow |x_{1} - x_{2}| = \frac{1}{4}|x_{1}y_{2} - x_{2}y_{1}|$
...
$l_{MA}: y=\frac{y_{1}}{x_{0}+1}(x+1)\Rightarrow P\left(0, \frac{y_{1}}{x_{2}+1}\right), l_{NB}: y=\frac{y_{2}}{x_{2}-1}(x-1)\Rightarrow Q\left(0, \frac{y_{2}}{1-x_{2}}\right)$ ，又 $|AT|=3, |BT|=$
...
解得 $b^{2}=16,\ c^{2}=25$ ，则双曲线 C 的标准方程为 $\frac{x^{2}}{9}-\frac{y^{2}}{16}=1$ ;
...
的圆心为 $\left(\frac{5}{2},0\right)$ ，半径为 $\frac{5}{2}$ ，当点N到直线AB的距离为 $\frac{5}{2}$ 时，点N的坐标为 $\left(\frac{5}{2},\frac{5}{2}\right)$ 或 $\left(\frac{5}{2},-\frac{5}{2}\right)$ ，因为点N在直线OM上，此时 $k_{OM}=\frac{16}{9k}=\pm1$ ，解得 $k=\frac{16}{9}$ 或 $k=-\frac{16}{9}$ ，其满足 $k^{2}\neq\frac{16}{9}$ ，则点N到直线AB的距离的最大值为 $\frac{5}{2}$ ，故△ABN面积的最大值 $S=\frac{1}{2}\times6\times\frac{5}{2}=\frac{15}{2}$ .
...
(3)若点 A、B 都在双曲线 C 的右支上，过点 A、B 分别作直线 L 的垂线，垂足分别为 P、Q，记 $\triangle AMP$ ， $\triangle BMQ$ ， $\triangle PMQ$ 的面积分别为 $S_{1}$ ， $S_{2}$ ， $S_{3}$ ，问：是否存在常数 m，使得 $S_{1}S_{2}=mS_{3}^{2}$ ？若存在，求出 m 的值；若不存在，请说明理由.
...
![](images/chunk_001_80e365586923243e504d1a04bcd2dfd1084cfb6cb8398e55e68d455e29e29d6a.jpg)
...
![](images/chunk_001_4fbc9c2472245d2bb5446a4d9297977fc4ef8db04a9d265ba6cafe0b1937b1d7.jpg)
