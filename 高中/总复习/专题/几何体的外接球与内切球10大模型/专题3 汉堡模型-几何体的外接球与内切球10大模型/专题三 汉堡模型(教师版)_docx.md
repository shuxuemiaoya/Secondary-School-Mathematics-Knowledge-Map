...
汉堡模型是直棱柱的外接球、圆柱的外接球模型，用找球心法(多面体的外接球的球心是过多面体的两个面的外心且分别垂直这两个面的直线的交点．一般情况下只作出一个面的垂线，然后设出球心用算术方法或代数方法即可解决问题．有时也作出两条垂线，交点即为球心．)解决．以直三棱柱为例，模型如下图，由对称性可知球心<em>O</em>的位置是△<em>ABC</em>的外心<em>O</em><sub>1</sub>与△<em>A</em><sub>1</sub><em>B</em><sub>1</sub><em>C</em><sub>1</sub>的外心<em>O</em><sub>2</sub>连线的中点，算出小圆<em>O</em><sub>1</sub>的半径<em>AO</em><sub>1</sub>＝<em>r</em>，<em>OO</em><sub>1</sub>＝，．

![](images/d7a66cc684e6bc200ae117212c8f3c030c98147337ab5e0c0a3bf43dfbbc7549.jpg)
...
另解　过<em>C</em>点作<em>AB</em>的平行线，过<em>B</em>点作<em>AC</em>的平行线，交点为<em>D</em>，同理过<em>C</em><sub>1</sub>作<em>A</em><sub>1</sub><em>B</em><sub>1</sub>的平行线，过<em>B</em><sub>1</sub>作<em>A</em><sub>1</sub><em>C</em><sub>1</sub>的平行线，交点为<em>D</em><sub>1</sub>，连接<em>DD</em><sub>1</sub>，则<em>ABCD</em>－<em>A</em><sub>1</sub><em>B</em><sub>1</sub><em>C</em><sub>1</sub><em>D</em><sub>1</sub>恰好成为球的一个内接长方体，故球的半径<em>r</em>＝．故选C．
...
1．答案　A　解析　由题知此直棱柱为正三棱柱<em>ABC</em>－<em>A</em><sub>1</sub><em>B</em><sub>1</sub><em>C</em><sub>1</sub>，设其上下底面中心为<em>O</em>′，<em>O</em><sub>1</sub>，则外接球

![](images/4a32f6ffe051b2d2ab3d6cb36d827f0940bf55bc9f47572cfddcd61fdab796f4.png)

的球心<em>O</em>为线段<em>O</em>′<em>O</em><sub>1</sub>的中点，∵<em>AB</em>＝2，∴<em>O</em>′<em>A</em>＝<em>AB</em>＝，<em>OO</em>′＝<em>O</em>′<em>O</em><sub>1</sub>＝1，∴<em>OA</em>＝＝，因此，它的外接球的半径为，故球<em>O</em>的表面积为．故选A．
...
面积为<em>S</em>＝6··＝，<em>V</em><sub>柱</sub>＝<em>Sh</em>＝<em>h</em>＝，∴<em>h</em>＝，<em>R</em><sup>2</sup>＝＋＝1，<em>R</em>＝1，球的体积为<em>V</em>＝.
...
3．答案　C　解析　如图所示，设底面边长为<em>a</em>，则底面面积为<em>a</em><sup>2</sup>＝，所以<em>a</em>＝.又一个侧面的

![](images/4a32f6ffe051b2d2ab3d6cb36d827f0940bf55bc9f47572cfddcd61fdab796f4.png)

周长为6，所以<em>AA</em><sub>1</sub>＝2.设<em>E</em>，<em>D</em>分别为上、下底面的中心，连接<em>DE</em>，设<em>DE</em>的中点为<em>O</em>，则点<em>O</em>即为正三棱柱<em>ABC</em>­<em>A</em><sub>1</sub><em>B</em><sub>1</sub><em>C</em><sub>1</sub>的外接球的球心，连接<em>OA</em><sub>1</sub>，<em>A</em><sub>1</sub><em>E</em>，则<em>OE</em>＝，<em>A</em><sub>1</sub><em>E</em>＝××＝1.在直角三角形<em>OEA</em><sub>1</sub>中，<em>OA</em><sub>1</sub>＝＝2，即外接球的半径<em>R</em>＝2，所以外接球的表面积<em>S</em>＝4π<em>R</em><sup>2</sup>＝16π，故选C．

![](images/2389654fd5dd1bd6555f18ca977727726b641f11896a935e6aa1eb679ae89bf6.jpg)

![](images/4a32f6ffe051b2d2ab3d6cb36d827f0940bf55bc9f47572cfddcd61fdab796f4.png)

![](images/4a32f6ffe051b2d2ab3d6cb36d827f0940bf55bc9f47572cfddcd61fdab796f4.png)

4．已知直三棱柱<em>ABC</em>－<em>A</em><sub>1</sub><em>B</em><sub>1</sub><em>C</em><sub>1</sub>的6个顶点都在球<em>O</em>的球面上，若<em>AB</em>＝3，<em>AC</em>＝1，∠<em>BAC</em>＝60°，<em>AA</em><sub>1</sub>
...
4．答案　B　解析　设△<em>A</em><sub>1</sub><em>B</em><sub>1</sub><em>C</em><sub>1</sub>的外心为<em>O</em><sub>1</sub>，△<em>ABC</em>的外心为<em>O</em><sub>2</sub>，连接<em>O</em><sub>1</sub><em>O</em><sub>2</sub>，<em>O</em><sub>2</sub><em>B</em>，<em>OB</em>，如图所示．

![](images/2ce907877545b06cc92eab50125ca0d1ec1d917303056e8eda1335d6b7b61c57.jpg)
...
5．答案　B　解析　其中<em>O</em><sub>1</sub>，<em>O</em><sub>2</sub>分别为正方形<em>AEFD</em>和<em>BCFE</em>的中心，<em>OO</em><sub>1</sub>，<em>OO</em><sub>2</sub>分别垂直于这两个平

![](images/4a32f6ffe051b2d2ab3d6cb36d827f0940bf55bc9f47572cfddcd61fdab796f4.png)

面．由于∠<em>OGO</em><sub>2</sub>＝60°，<em>O</em><sub>2</sub><em>G</em>＝，所以<em>OO</em><sub>2</sub>＝，而<em>O</em><sub>2</sub><em>C</em>＝<em>CE</em>＝，所以球的半径<em>OC</em>＝＝，所以球的表面积为4π·<em>OC</em><sup>2</sup>＝5π．故选B．
...
6．答案　A　解析　设△<em>ABC</em>外接圆圆心为<em>O</em><sub>1</sub>，半径为<em>r</em>，连接<em>O</em><sub>1</sub><em>O</em>，如图，易得<em>O</em><sub>1</sub><em>O</em>⊥平面<em>ABC</em>，

![](images/d437df3abc91b2ca27e12bd1fae40de73ec3c02016cc01f945a1535f221ee974.jpg)
