...
$$
\therefore | O T | ^ {2} = x _ {0} ^ {\prime 2} + y _ {0} ^ {\prime 2} = \frac {4 k ^ {2}}{m ^ {2}} + \frac {1}{4 m ^ {2}} = 2 - \frac {3}{4 m ^ {2}} \in \left[ \frac {1}{2}, 2 \right], \quad \therefore | O T | \in \left[ \frac {\sqrt {2}}{2}, \sqrt {2} \right].
$$
