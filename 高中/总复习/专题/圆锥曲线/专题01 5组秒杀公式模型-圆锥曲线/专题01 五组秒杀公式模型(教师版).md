...
$= 2|AF'|$ ，因此椭圆 $C$ 的离心率为 $\frac{2c}{2a} = \frac{|FF'|}{|AF| + |AF'|} = \frac{2}{\sqrt{3} + 1} = \sqrt{3} -1.$  
...
A 在双曲线 C 上，所以 $b^{2}x_{0}^{2}-a^{2}y_{0}^{2}=a^{2}b^{2}$ ， $b^{2}x_{1}^{2}-a^{2}y_{1}^{2}=a^{2}b^{2}$ ，两式相减可得 $\frac{y_{0}^{2}-y_{1}^{2}}{x_{0}^{2}-x_{1}^{2}}=\frac{b^{2}}{a^{2}}$ ，故 $\frac{b^{2}}{a^{2}}=3$ ，于是 $b^{2}=3a^{2}$ 。又因为 $c^{2}=a^{2}+b^{2}$ ，所以双曲线 C 的离心率 $e=\sqrt{1+\left(\frac{b}{a}\right)^{2}}=2$ 。故选 
A.  
