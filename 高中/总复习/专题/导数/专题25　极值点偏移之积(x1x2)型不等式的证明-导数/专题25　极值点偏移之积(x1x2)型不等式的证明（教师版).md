...
$$
\therefore h ^ {\prime} (x) = 4 x - \frac {1}{x} \left(x ^ {2} + \mathrm{e} ^ {2}\right) - 2 x \ln x = 3 x - \frac {\mathrm{e} ^ {2}}{x} - 2 x \ln x, \text {则} h ^ {\prime} (\mathrm{e}) = 0.
$$

$$
\therefore h ^ {\prime \prime} (x) = 3 + \frac {\mathrm{e} ^ {2}}{x ^ {2}} - 2 (1 + \ln x) = 1 + \frac {\mathrm{e} ^ {2}}{x ^ {2}} - 2 \ln x, \text {则} h ^ {\prime \prime} (\mathrm{e}) = 0.
$$

$$
\because h ^ {\prime \prime} (x) \text {单调递减，} \therefore h ^ {\prime \prime} (x) <   h ^ {\prime \prime} (e) = 0, \therefore h ^ {\prime} (x) \text {单调递减，} \therefore h ^ {\prime} (x) <   h ^ {\prime} (e) = 0.
$$
...
$$
h ^ {\prime} (x) = \ln x + 1 - (k + 1) + \mathrm{e} ^ {2 k} \left(\frac {1 - \ln x}{x ^ {2}} + \frac {k - 1}{x ^ {2}}\right) = (\ln x - k) \frac {x ^ {2} - \mathrm{e} ^ {2 k}}{x ^ {2}},
$$
...
令 $\frac{x_1}{x_2} = t\in (0,1)$ ，则 $h(t) = (1 + t)\ln t - 2t + 2$ ，则 $h^{\prime}(t) = \ln t + \frac{1}{t} -1,\quad h^{\prime \prime}(t) = \frac{1}{t} -\frac{1}{t^{2}} < 0.$
...
$$
(2) g (x) = f (x) - \frac {1}{2} x ^ {2} + 1 = e ^ {x} - \frac {1}{2} x ^ {2} - a x, g ^ {\prime} (x) = e ^ {x} - x - a,
$$
