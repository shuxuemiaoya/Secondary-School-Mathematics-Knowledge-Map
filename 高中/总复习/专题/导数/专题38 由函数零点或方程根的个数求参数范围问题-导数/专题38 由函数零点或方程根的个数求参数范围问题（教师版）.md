...
$$
f ^ {\prime} (x) = 2 x - \frac {2}{x ^ {2}} - \frac {7}{x}, \therefore f ^ {\prime} (1) = - 7, f (1) = 3,
$$
...
$$
\therefore f ^ {\prime} (x) = \frac {- 2 a x ^ {2} + x + 1}{x} = \frac {- 2 a \left(x - x _ {1}\right) \left(x - x _ {2}\right)}{x}, x > 0.
$$
...
$$
t ^ {\prime} (x) = \frac {\mathrm{e} ^ {x} (x ^ {2} - x \ln x - 2 x + \ln x + 1)}{[ x (x - \ln x) ] ^ {2}}, \text {令} m (x) = x ^ {2} - x \ln x - 2 x + \ln x + 1,
$$
