...
$\text { 令 } g (x) = - x \ln x + 2 \mathrm{e} - x, g ^ {'} (x) = - \ln x + (- x) \cdot \frac {1}{x} - 1 = - \ln x - 2,$
...
$\therefore F ^ {'} (x) = \frac {1 - x}{\mathrm{e} ^ {x}} + 1 - \frac {1}{x} = (x - 1) \frac {\mathrm{e} ^ {x} - x}{x \mathrm{e} ^ {x}}. \quad \because x > 0, \quad \therefore \mathrm{e} ^ {x} > x + 1,$
...
$\therefore g ^ {'} (x) = \frac {2 a}{a x + 2} + 2 x - a = \frac {2 a x \left(x + \frac {4 - a ^ {2}}{2 a}\right)}{a x + 2},$
...
$h ^ {'} (a) = \frac {2}{a + 1} - 2 + 2 k a = \frac {2 a (k a + k - 1)}{a + 1}.$
...
$h ^ {'} (x) = \left(x ^ {2} + x - 2\right) \mathrm{e} ^ {x} = (x - 1) (x + 2) \mathrm{e} ^ {x}, x > - 1,$
...
$\therefore f (x _ {1}) _ {\min} = f (\mathrm{e}) = \mathrm{e} - m - \frac {m - 1}{\mathrm{e}}. \text {又} g ^ {'} (x) = x + \mathrm{e} ^ {x} - (x + 1) \mathrm{e} ^ {x} = x (1 - \mathrm{e} ^ {x}),$
