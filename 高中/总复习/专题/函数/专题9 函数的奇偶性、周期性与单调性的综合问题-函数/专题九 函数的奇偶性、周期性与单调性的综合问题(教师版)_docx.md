...
A．*f*(*x*)图象关于原点对称　　　　　　　　　　B．*f*(*x*)图象关于*y*轴对称

C．<em>f</em>(<em>x</em>)在<strong>R</strong>上单调递增　　　　　　　　　　　D．<em>f</em>(<em>x</em>)在<strong>R</strong>上单调递减
...
A．减函数且*f*(*x*)>0　　B．减函数且*f*(*x*)<0　　C．增函数且*f*(*x*)>0　　D．增函数且*f*(*x*)<0
...
A．函数*f*(*x*)的最小正周期是1　　　　　　　　B．函数*f*(*x*)是单调递减函数

C．函数*f*(*x*)的图象关于直线*x*＝1轴对称　　　D．函数*f*(*x*)的图象关于(1，0)中心对称
...
A．增函数且*f*(*x*)>0　　B．增函数且*f*(*x*)<0　　C．减函数且*f*(*x*)>0　　D．减函数且*f*(*x*)<0
...
A．函数*f*(*x*)是偶函数　　　　　　　　　　B．函数*f*(*x*)是减函数

C．函数*f*(*x*)是周期函数　　　　　　　　　D．函数*f*(*x*)的值域为[－1，＋∞)
...
A．*f*(－31)＜*f*(84)＜*f*(13)　　　　　　　　　　　B．*f*(84)＜*f*(13)＜*f*(－31)

C．*f*(13)＜*f*(84)＜*f*(－31)　　　　　　　　　　　D．*f*(－31)＜*f*(13)＜*f*(84)
...
A．*f* >*f*(2)>*f*(3)　　B．*f*(3)>*f*(2)>*f*　　C．*f* >*f*(3)>*f*(2)　　D．*f*(3)>*f* >*f*(2)
...
A．*f*(－3)<*f*(2)<*f* 　　B．*f* <*f*(－3)<*f*(2)　　C．*f*(2)<*f*(－3)<*f* 　　D．*f*(2)<*f* <*f*(－3)
