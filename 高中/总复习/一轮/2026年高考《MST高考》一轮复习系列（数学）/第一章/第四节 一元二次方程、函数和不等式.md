...
A. $\{x\mid-3<x<\frac{1}{4}\}$

B. $\{x\mid x <   - 4$ 或 $x > \frac{1}{3}\}$

C. $\{x \mid -4 < x < \frac{1}{3}\}$

D. $\{x\mid x <   - 3$ 或 $x > \frac{1}{4}\}$
...
C. 不等式 $\frac{12ax - c}{x - 2} > 0$ 的解集为 $\{x \mid -1 < x < 2\}$

D. 不等式 $bx^{2} + 2ax - c - 3b \leqslant 0$ 的解集为 $\{x \mid -3 \leqslant x \leqslant 5\}$
...
D. $\left(-\frac{5}{4},1-\sqrt{2}\right)$
