...
A. $\frac{a\cos\alpha\sin(\gamma-\alpha)}{\sin(\gamma-\beta)}$

B. $\frac{a\sin\alpha\sin(\gamma - \alpha)}{\sin(\gamma - \beta)}$

C. $\frac{a\cos\alpha\sin(\gamma-\beta)}{\sin(\gamma-\alpha)}$

D. $\frac{a\sin\alpha\sin(\gamma - \beta)}{\sin(\gamma - \alpha)}$
...
A. $\left(\frac{43}{15},\frac{59}{15}\right)$

B. $\left[2\sqrt{2},\frac{43}{15}\right)$

C. $[2\sqrt{2},\frac{59}{15})$
