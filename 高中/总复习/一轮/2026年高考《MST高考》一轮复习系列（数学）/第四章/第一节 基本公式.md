...
Black folding fan with radial pages, no visible text or symbols
</details>
...
B. $\sin \alpha \cos \alpha = -\frac{12}{25}$

C. $\cos\alpha-\sin\alpha=\frac{7}{5}$

D. $\cos \alpha -\sin \alpha = -\frac{7}{5}$
