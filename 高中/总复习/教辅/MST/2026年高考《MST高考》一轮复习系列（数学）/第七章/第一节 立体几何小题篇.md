...
$\quad$A. 直线 $A_{1} D$ 与直线 $D_{1} B$ 垂直, 直线 $M N / /$ 平面 $A B C D$   
$\quad$B. 直线 $A_{1}D$ 与直线 $D_{1}B$ 平行，直线 $MN \perp$ 平面 $BDD_{1}B_{1}$   
$\quad$C. 直线 $A_{1}D$ 与直线 $D_{1}B$ 相交, 直线 $MN \parallel$ 平面 $ABCD$   
$\quad$D. 直线 $A_{1}D$ 与直线 $D_{1}B$ 异面，直线 $MN \perp$ 平面 $BDD_{1}B_{1}$

【例 3】（2024 天津卷） 若 m, n 为两条不同的直线， $\alpha$ 为一个平面，则下列结论中正确的是（）

$\quad$A. 若 $m / / \alpha$ ， $n \subset \alpha$ ，则 $m / / n$

$\quad$B. 若 $m \parallel \alpha, n \parallel \alpha$ ，则 $m \parallel n$

$\quad$C. 若 $m / / \alpha, n \perp \alpha$ ，则 $m \perp n$

$\quad$D. 若 $m / / \alpha, n \perp \alpha$ ，则 $m$ 与 $n$ 相交
...
$\quad$A. $h=\frac{\sqrt{6}}{3}a$

$\quad$B. $R = 2r$

$\quad$C. $\sin \alpha = \frac{\sqrt{6}}{3}$

$\quad$D. $\cos\beta=\frac{1}{2}$
...
$\quad$A. 直径为 $0.99m$ 的球体

$\quad$B. 所有棱长均为 $1.4 m$ 的四面体

$\quad$C. 底面直径为 $0.01m$ ，高为 $1.8m$ 的圆柱体
...
$\quad$A. $\lambda=\frac{1}{2}$ 时，截面面积为 $\frac{\sqrt{3}}{2}$

$\quad$B. $\lambda=\frac{1}{2}$ 时， $V_{1}=V_{2}$

$\quad$C. $|V_{1} - V_{2}|$ 随着 $\lambda$ 的增大先减小后增大

$\quad$D. $|V_{1} - V_{2}|$ 的最大值为 $\frac{5}{12}$
...
$\quad$A. $PA \perp EF$   
$\quad$B. 三棱锥 $M - AEF$ 的体积为4  
$\quad$C. 三棱锥 $P - AEF$ 外接球的表面积为 $24 \pi$   
$\quad$D. 过点 $M$ 的平面截三棱锥 $P - AEF$ 的外接球所得截面的面积的取值范围为 $[\pi, 6\pi]$
...
$\quad$C. $\frac{9\sqrt{2}}{2}$

$\quad$D. $\frac{9\sqrt{2}}{8}$
...
$\quad$C. $\frac{2\sqrt{2}\pi}{3}$

$\quad$D. $\frac{4\sqrt{2}\pi}{3}$
...
$\quad$A. $\left[\frac{\sqrt{29}}{4},2\right]$

$\quad$B. $\left[\frac{\sqrt{21}}{4},\sqrt{3}\right]$

$\quad$C. $\left[\frac{\sqrt{41}}{4},\sqrt{3}\right]$

$\quad$D. $[\frac{\sqrt{7}}{4},\sqrt{3} ]$
...
$\quad$A. 当 $\lambda = \mu$ 时， $BP //$ 平面 $CB_{1}D_{1}$   
$\quad$B. 当 $\mu = \frac{1}{2}$ 时，存在唯一点 $P$ 使得 $DP$ 与直线 $CB_{1}$ 的夹角为 $\frac{\pi}{3}$   
$\quad$C. 当 $\lambda + \mu = 1$ 时， $DP + PB$ 的最小值为 $\sqrt{2 + \sqrt{2}}$   
$\quad$D. 当点 $P$ 落在以 $B_{1}$ 为球心， $\sqrt{2}$ 为半径的球面上时， $\lambda + \mu$ 的最小值为 $2 - \sqrt{2}$
...
$\overrightarrow {A C} \cdot \overrightarrow {B D} = \frac {\overrightarrow {A D ^ {2}} + \overrightarrow {B C ^ {2}} - \overrightarrow {A B ^ {2}} - \overrightarrow {C D ^ {2}}}{2} = \frac {\overrightarrow {A ^ {'} D ^ {2}} + \overrightarrow {B C ^ {2}} - \overrightarrow {A ^ {'} B ^ {2}} - \overrightarrow {C D ^ {2}}}{2} = \overrightarrow {A ^ {'} C} \cdot \overrightarrow {B D}.$
...
$\quad$D. 对任意位置, 三对直线 $AC$ 与 $BD$ , $AB$ 与 $CD$ , $AD$ 与 $BC$ 均不垂直
...
$\quad$A. $\alpha \leq \beta \leq \gamma$

$\quad$B. $\beta \leq \alpha \leq \gamma$

$\quad$C. $\beta \leq \gamma \leq \alpha$

$\quad$D. $\alpha \leq \gamma \leq \beta$
...
$\quad$A. $\beta < \gamma, \alpha < \gamma$

$\quad$B. $\beta <  \alpha ,\quad \beta <  \gamma$

$\quad$C. $\beta < \alpha, \gamma < \alpha$

$\quad$D. $\alpha < \beta, \gamma < \beta$
...
$\quad$A. $\theta_{1} \leq \theta_{2} \leq \theta_{3}$

$\quad$B. $\theta_{3} \leq \theta_{2} \leq \theta_{1}$

$\quad$C. $\theta_{1} \leq \theta_{3} \leq \theta_{2}$

$\quad$D. $\theta_{2} \leq \theta_{3} \leq \theta_{1}$
...
$\quad$B. $(0, \frac{\sqrt{6}}{3})$

$\quad$C. $\left(\frac{\sqrt{2}}{2},\sqrt{2}\right)$

$\quad$D. $\left(\frac{\sqrt{6}}{3},\sqrt{2}\right)$
