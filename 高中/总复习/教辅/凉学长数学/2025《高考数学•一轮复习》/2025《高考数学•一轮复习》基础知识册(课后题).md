...
$\quad$B. $\left\{x\left|\frac{1}{3}\leq x<4\right.\right\}$

$\quad$C. $\left\{x\mid4\leq x<5\right\}$

$\quad$D. $\left\{x\mid0<x\leq5\right\}$
...
$\quad$B. $\exists x_0\in R,\quad x^2 +1\leq 0$

$\quad$C. $\exists \mathbf{x}_0\in R,\mathbf{x}^2 +1 <   0$

$\quad$D. $\forall x_{0}\in R,\quad x^{2} + 1\leq 0$
...
$\quad$C. $\forall x\in \complement_{\mathbf{R}}\mathbf{Q},\quad x^{3}\in Q$

$\quad$D. $\forall x\in C_{R}Q,\quad x^{3}\notin Q$
...
$\quad$B. $y = d \cdot \log_{r} x + s (d > 0, r > 1)$
...
【练习1】.如图, 函数 $y = f\left( x\right)$ 的图象在点 $P$ 处的切线方程是 $y =  - x + 8$ , 则 $f\left( 5\right)  + {f}^{' }\left( 5\right)  =$ (   )
...
$\quad$D. $\overrightarrow{b} - \overrightarrow{a}$
...
$\quad$B. $4 \vec{e}_{1} - 2 \vec{e}_{2}$ 和 $6 \vec{e}_{1} - 3 \vec{e}_{2}$

$\quad$C. $2 \vec { e } _ { 1 } - \vec { e } _ { 2 }$ 和 $\vec { e } _ { 2 }$

$\quad$D. $\vec{e}_{1}-\vec{e}_{2}$ 和 $2\vec{e}_{2}+\vec{e}_{1}$
...
$\quad$A. $b \subset \alpha, a \parallel b$   
...
$\quad$A. $MN \parallel PD$

$\quad$B. $MN \parallel PA$

$\quad$C. $MN \parallel AD$
...
$\quad$A. 若 $\alpha \perp \beta, m \parallel \alpha, l \parallel \beta$ , 则 $m \perp l$

$\quad$B. 若 $m \subset \alpha, l \subset \beta, m \parallel l$ ，则 $\alpha \parallel \beta$

$\quad$C. 若 $\alpha \cap \beta = m, l \parallel \alpha, l \parallel \beta$ , 则 $m \parallel l$

$\quad$D. 若 $m \perp \alpha, l \perp \beta, m \parallel l$ ，则 $\alpha \perp \beta$
...
$\quad$A. $\left(-\frac{1}{2},1\right),\quad\frac{\sqrt{3}}{2}$
...
$\quad$B. $C_{1}$ 的渐近线斜率的绝对值较大, $C_{1}$ 的开口较狭窄  
...
$\quad$D. 用比例分配的分层随机抽样方法从该校高一学生抽取 20 人, 则生史地组合抽取 6 人
...
$\quad$A. 甲的射箭成绩的中位数为 $61.5 \mathrm{~mm}$

$\quad$B. 乙的射箭成绩的平均数为 $78$
...
$\quad$A. 变量 $x$ 与 $y$ 呈现正相关，且 $\left|r_{1}\right| > \left|r_{2}\right|$   
$\quad$B. 变量 $x$ 与 $y$ 呈现负相关，且 $\left|r_{1}\right| < \left|r_{2}\right|$   
$\quad$C. 变量 u 与 v 呈现正相关，且 $\left|r_{1}\right| > \left|r_{2}\right|$   
$\quad$D. 变量 $u$ 与 $v$ 呈现负相关, 且 $\left|r_{1}\right|<\left|r_{2}\right|$
