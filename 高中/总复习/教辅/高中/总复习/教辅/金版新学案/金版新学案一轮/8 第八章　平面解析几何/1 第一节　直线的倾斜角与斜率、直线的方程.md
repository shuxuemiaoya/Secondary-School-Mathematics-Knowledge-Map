...
A.平面直角坐标系中的直线都有倾斜角与斜率

B.直线的倾斜角越大，其斜率就越大

C.直线*y*＝*kx*－2一定过定点(0，－2)

D.经过任意两个不同的点<em>P</em><sub>1</sub>(<em>x</em><sub>1</sub>，<em>y</em><sub>1</sub>)，<em>P</em><sub>2</sub>(<em>x</em><sub>2</sub>，<em>y</em><sub>2</sub>)的直线都可以用方程(<em>y</em>－<em>y</em><sub>1</sub>)·(<em>x</em><sub>2</sub>－<em>x</em><sub>1</sub>)＝(<em>x</em>－<em>x</em><sub>1</sub>)(<em>y</em><sub>2</sub>－<em>y</em><sub>1</sub>)表示
...
解析：由斜率公式得 $\frac{4－m}{m+2}$ ＝1，解得*m*＝1.故选A.
...
A.[0，π)	B. $\left[0，\frac{\pi }{4}\right]$ ∪ $\left[\frac{3\pi }{4}，\pi \right)$

C. $\left[0，\frac{\pi }{4}\right]$ 	D. $\left[0，\frac{\pi }{4}\right]$ ∪ $\left(\frac{\pi }{2}，\pi \right)$

答案：**B**

解析：设直线的倾斜角为*<text style="italic"><text style="italic"><text style="italic"><text style="italic"><text style="italic">θ*</text></text></text></text></text>，则有tan θ＝－sin *<text style="italic">α*</text>.因为sin α∈[－1，1]，所以－1≤tan θ≤1，又θ∈[0，π)，所以0≤θ≤ $\frac{\pi }{4}$ 或 $\frac{3\pi }{4}$ ≤*<text style="italic"><text style="italic"><text style="italic"><text style="italic"><text style="italic">θ*</text></text></text></text></text>＜π.故选B.
...
A.<em>k</em><sub>1</sub>＜<em>k</em><sub>2</sub>＜<em>k</em><sub>3</sub>

B.<em>k</em><sub>3</sub>＜<em>k</em><sub>1</sub>＜<em>k</em><sub>2</sub>

C.<em>k</em><sub>3</sub>＜<em>k</em><sub>2</sub>＜<em>k</em><sub>1</sub>

D.<em>k</em><sub>1</sub>＜<em>k</em><sub>3</sub>＜<em>k</em><sub>2</sub>

答案：**D**

解析：因为直线<em>l</em><sub>2</sub>，<em>l</em><sub>3</sub>的倾斜角为锐角，且直线<em>l</em><sub>2</sub>的倾斜角大于直线<em>l</em><sub>3</sub>的倾斜角，所以0＜<em>k</em><sub>3</sub>＜<em>k</em><sub>2</sub>.直线<em>l</em><sub>1</sub>的倾斜角为钝角，斜率<em>k</em><sub>1</sub>＜0，所以<em>k</em><sub>1</sub>＜<em>k</em><sub>3</sub>＜<em>k</em><sub>2</sub>.故选D.
...
解析：如图，因为<em>&lt;text style="italic"&gt;&lt;text style="italic"&gt;k</em>&lt;/text&gt;&lt;/text&gt;<em><sub>AP</sub></em>＝ $\frac{1－0}{2－1}$ ＝1，<em>&lt;text style="italic"&gt;&lt;text style="italic"&gt;k</em>&lt;/text&gt;&lt;/text&gt;<em><sub>BP</sub></em>＝ $\frac{\sqrt{3}－0}{0－1}$ ＝－ $\sqrt{3}$ ，所以<em>&lt;text style="italic"&gt;&lt;text style="italic"&gt;k</em>&lt;/text&gt;&lt;/text&gt;∈(－∞，－ $\sqrt{3}$ ]∪[1，＋∞).设直线的倾斜角为<em>&lt;text style="italic"&gt;&lt;text style="italic"&gt;&lt;text style="italic"&gt;θ</em>&lt;/text&gt;&lt;/text&gt;&lt;/text&gt;，则有tan θ≤－ $\sqrt{3}$ ，或tan <em>&lt;text style="italic"&gt;&lt;text style="italic"&gt;&lt;text style="italic"&gt;θ</em>&lt;/text&gt;&lt;/text&gt;&lt;/text&gt;≥1，所以 $\frac{\pi }{4}$ ≤<em>&lt;text style="italic"&gt;&lt;text style="italic"&gt;&lt;text style="italic"&gt;θ</em>&lt;/text&gt;&lt;/text&gt;&lt;/text&gt;≤ $\frac{2\pi }{3}$ ，即倾斜角的取值范围为［ $\frac{\pi }{4}$ ， $\frac{2\pi }{3}$ ］.
...
A.<te*x*t style="italic">y</text>－3＝－ $\frac{3}{2}$ (*x*＋4)

B.<te*x*t style="italic">y</text>＋3＝ $\frac{3}{2}$ (*x*－4)

C.<te*x*t style="italic">y</text>－3＝ $\frac{3}{2}$ (*x*＋4)

D.<te*x*t style="italic">y</text>＋3＝－ $\frac{3}{2}$ (*x*－4)

答案：**C**

解析：法一：因为直线&lt;te<em>x</em>t st<em>y</em>&lt;text sty<em>l</em>e="italic"&gt;l&lt;/text&gt;e="italic"&gt;l&lt;/text&gt;的一个方向向量为<em><strong>n</strong></em>＝(2，3)，所以直线l的斜率<em>k</em>＝ $\frac{3}{2}$ ，故直线&lt;te<em>x</em>t st<em>y</em>&lt;text sty<em>l</em>e="italic"&gt;l&lt;/text&gt;e="italic"&gt;l&lt;/text&gt;的方程为y－3＝ $\frac{3}{2}$ (<em>x</em>＋4).故选C.
...
**课时测评**66　**直线的倾斜角与斜率、直线的方程** $\frac{对应学生}{用书P441}$
...
A.<te<te*x*t st*y*le="italic">x</text>t style="italic">y</text>＝ $\sqrt{3}$ <te*x*t st*y*le="italic">x</text>＋2	B.*y*＝ $\sqrt{3}$ <te*x*t st*y*le="italic">x</text>－2

C.<te<te*x*t st*y*le="italic">x</text>t style="italic">y</text>＝ $\sqrt{3}$ <te*x*t st*y*le="italic">x</text>－ $\frac{1}{2}$ 	D.<te<te*x*t st*y*le="italic">x</text>t style="italic">y</text>＝－ $\sqrt{3}$ <te*x*t st*y*le="italic">x</text>－2

答案：**A**

解析：直线<te*x*t st<text st<text st*yl*e="italic">y</text>*l*e="italic">y</text>le="italic">x</text>－2y－4＝0的斜率为 $\frac{1}{2}$ ，所以直线<te*x*t st<text st*yl*e="italic">y</text>le="italic">l</text>在*y*轴上的截距为2，所以直线l的方程为y＝ $\sqrt{3}$ <te*x*t st<text st<text st*yl*e="italic">y</text>*l*e="italic">y</text>le="italic">x</text>＋2.故选A.
...
解析：由题意可知直线<te*x*t st<text st*y*le="italic">y</text>*l*e="italic">l</text>的斜率存在且不为0，设直线l的方程为y＝*<text style="italic"><text style="italic"><text style="italic"><text style="italic"><text style="italic">k*</text></text></text></text>x</text>＋*<text style="italic"><text style="italic"><text style="italic"><text style="italic">b*</text></text></text></text>(k≠0)，则平移后直线的方程为y＝k(x－3)＋b－2＝(*<text style="italic"><text style="italic">kx*</text></text>＋b)＋(－3k－2)，可得kx＋b＝(kx＋b)＋(－3k－2)，即k＝－ $\frac{2}{3}$ .故选C.
...
解析：由题意<em>l</em><sub>1</sub>：<em>y</em>＝－<em>ax</em>－<em>b</em>，<em>l</em><sub>2</sub>：<em>y</em>＝－<em>bx</em>－<em>a</em>，所以直线<em>l</em><sub>1</sub>的斜率、<em>y</em>轴上的截距分别与直线<em>l</em><sub>2</sub>在<em>y</em>轴上的截距、斜率符号相同，分析选项可知B符合.故选B.

5.(多选)已知直线*l*的方程为*ax*＋*by*－2＝0，则下列判断正确的是(　　)

A.若*ab*＞0，则直线*l*的斜率小于0

B.若*b*＝0，*a*≠0，则直线*l*的倾斜角为90°

C.直线*l*可能经过坐标原点

D.若*a*＝0，*b*≠0，则直线*l*的倾斜角为0°
...
A.4*x*－3*y*＋1＝0	B.3*x*－4*y*－1＝0

C.4*x*＋3*y*＋1＝0	D.3*x*＋4*y*－1＝0

答案：**C**

解析：因为直线<em>a</em><sub>1</sub><em>x</em>＋<em>b</em><sub>1</sub><em>y</em>＋1＝0和直线<em>a</em><sub>2</sub><em>x</em>＋<em>b</em><sub>2</sub><em>y</em>＋1＝0都过点<em>A</em>(4，3)，所以4<em>a</em><sub>1</sub>＋3<em>b</em><sub>1</sub>＋1＝0，4<em>a</em><sub>2</sub>＋3<em>b</em><sub>2</sub>＋1＝0.由上式可得点<em>P</em><sub>1</sub>(<em>a</em><sub>1</sub>，<em>b</em><sub>1</sub>)和点<em>P</em><sub>2</sub>(<em>a</em><sub>2</sub>，<em>b</em><sub>2</sub>)都在直线4<em>x</em>＋3<em>y</em>＋1＝0上，即过点<em>P</em><sub>1</sub>(<em>a</em><sub>1</sub>，<em>b</em><sub>1</sub>)和点<em>P</em><sub>2</sub>(<em>a</em><sub>2</sub>，<em>b</em><sub>2</sub>)的直线方程为4<em>x</em>＋3<em>y</em>＋1＝0.故选C.
...
解析：当过<em>A</em>(2，1)的直线将圆1与圆2平分，过<em>B</em>(3，4)的直线将圆3与圆4平分时，<em>L</em>划分为面积相等的两个区域且<em>k<sub>AB</sub></em>＝ $\frac{4－1}{3－2}$ ＝3，
