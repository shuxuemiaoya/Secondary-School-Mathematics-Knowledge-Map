...
$\quad$A. 0 是 $f(x)$ 的极大值, 也是 $g(x)$ 的极大值  
$\quad$B. 0 是 $f(x)$ 的极小值, 也是 $g(x)$ 的极小值  
$\quad$C. 0 是 $f(x)$ 的极大值,但不是 $g(x)$ 的极值  
$\quad$D. 0 是 $f(x)$ 的极小值, 但不是 $g(x)$ 的极值
...
$\quad$C. $\left(0, \frac{\sqrt{3}}{2}\right]$
...
$\quad$A. 以 $a$ 为斜边的直角三角形  
$\quad$B. 以 $b$ 为斜边的直角三角形  
$\quad$C. 等边三角形  
$\quad$D. 以上结论都不对
...
$\quad$B. $\left(\frac{2}{3}\right)^{n-1}$

$\quad$C. $\left(\frac{2}{3}\right)$
...
$\quad$A. $a_0 = 1$   
$\quad$B. $a_{2} + a_{4} + a_{6} + \dots +a_{10} = \frac{3^{10} - 1}{2}$   
$\quad$C. $a_0 + a_1 + a_2 + \dots + a_{10} = 3^{10}$   
$\quad$D. $a_{1}+a_{3}+\cdots+a_{9}=\frac{3^{10}+1}{2}$
...
则 $f'(x) = \frac{1 - \ln x}{x^{2}}$ ，当 $x\in (\mathrm{e}, + \infty)$ 时， $f'(x) <   0$ ，故 $f(x)$ 在 $(\mathrm{e}, + \infty)$ 上单调递减，
...
$\begin{array}{l} = S _ {\triangle A B C} \cdot h - \frac {1}{3} S _ {\triangle A B C} \cdot h _ {1} - \frac {1}{3} S _ {\triangle A ^ {'} B ^ {'} C ^ {'}} \cdot h _ {2} \\ = S _ {\triangle A B C} \cdot h - \frac {1}{3} S _ {\triangle A B C} \cdot \left(h _ {1} + h _ {2}\right) \\ = \frac {2}{3} S _ {\triangle A B C} \cdot h \\ = \frac {2}{3} V. \text {   故选   } A. \\ \end{array}$
