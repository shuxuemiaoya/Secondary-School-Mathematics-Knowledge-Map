...
Cartoon star character wearing a yellow shirt with '100' and a blue-and-white tie, giving a thumbs-up gesture (no text or symbols on the character itself)
</details>
...
Portrait of a man wearing a blue polo shirt with a patterned collar (no visible text or symbols)
</details>
...
Portrait of a man wearing a blue striped polo shirt (no visible text or symbols)
</details>
...
Portrait of a man in a patterned shirt (no text or symbols visible)
</details>
...
Portrait of a man wearing a blue shirt and orange card (no visible text or symbols)
</details>
...
Portrait of a man wearing a black shirt with a blue geometric pattern (no text or symbols visible)
</details>
...
讲点关键题词
作文素材上 名校模考满分作文
作者：张晓东  等编：李小平  第5卷一卷一题文
14篇论文答辩，答辩者须在《考试评报》、《评报》等文件上签字。
100篇论文答辩，答辩者须在《评报》、《评报》等文件上签字。
CHINA CITIC PRESS
</details>
...
试题思辨析：能做作文平面
作者：张小明 等著
ISBN: 978-7-514-6000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-0000-
</details>
...
A. a 与 b 的夹角为 $\frac{\pi}{6}$

B. $(\pmb {a} - \pmb {c})\cdot (\pmb {b} - \pmb {c})$ 的最大值为5

C. $|c|$ 的最小值为 2

D. 若 $c = x a + y b (x, y \in R)$ ，则 $\frac{1}{3} \leqslant \frac{1}{2} x + y \leqslant \frac{7}{6}$
...
A. versin $\frac{2025\pi}{6}=\frac{3}{2}$

B. 函数 $f(\theta) = \text{versin} \theta \cdot \text{coversin} \theta$ 的最大值为 $\frac{3 + 2\sqrt{2}}{2}$

C. 存在一个 $\theta$ ，使函数 $f(\theta) = \text{versin } \theta - \text{coversin } \theta$ 的值为 $\frac{3}{2}$

D. 将函数 $f(\theta) = \text{coversin} \theta$ 的图象向左平移 $\frac{\pi}{2}$ 个单位长度后, 可得函数 $g(\theta) = \text{versin} \theta$ 的图象
...
A. $\overrightarrow{CM} \cdot \overrightarrow{CB} = 4$

B. 当 $\lambda = \frac{1}{2}$ 时, $\overrightarrow{AC} \cdot \overrightarrow{MN} = 0$

C. 当 $\lambda = \frac{1}{3}$ 时, $\cos \langle \overrightarrow{CM}, \overrightarrow{CN} \rangle = \frac{9\sqrt{130}}{130}$

D. $|\overrightarrow{MN}|$ 的最小值为2
...
A. 若 a, b 为非零向量，且 $\left|a \times b\right| = \left|a \cdot b\right|$ ，则 $\left\langle a, b\right\rangle = \frac{\pi}{4}$   
B. 若四边形 ABCD 为平行四边形, 则它的面积等于 $\left|\overrightarrow{AB} \times \overrightarrow{AC}\right|$   
C. 已知点 $A(2,0), B(-1, \sqrt{3}), O$ 为坐标原点，则 $\vert \overrightarrow{OA} \times \overrightarrow{OB} \vert = 2\sqrt{3}$   
D. 若 $\left|a \times b\right| = \frac{\sqrt{3}}{3} a \cdot b = \sqrt{3}$ ，则 $\left|a + 2b\right|$ 的最小值为 $12 + 8\sqrt{3}$
...
A. $\overrightarrow{OA} \cdot \overrightarrow{OB}$ 是定值

B. $\overrightarrow{CA} \cdot \overrightarrow{CB}$ 是定值

C. $\overrightarrow{AC}$ 在 $\overrightarrow{AB}$ 上的投影向量的模的最大值为 1

D. 当且仅当 $k=\frac{1}{2}$ 时， $|AB|=2$
...
Illustration of a traditional waterwheel with a wooden wheel and surrounding vegetation (no text or symbols)
</details>
...
A. 筒车转动的角速度 $\omega = \frac{\pi}{60}$ rad/s  
B. 当筒车旋转 50 秒时, 盛水筒 M 对应的点 P 的纵坐标为 $-2\sqrt{3}$   
C. 当筒车旋转 50 秒时, 盛水筒 M 对应的点 P 和初始点 $P_{0}$ 的水平距离为 6  
D. 筒车在 $t \in (0,60]$ 的旋转过程中, 盛水筒 M 对应的最高点到 x 轴的距离为 6
...
A. $f(x) = 4\sqrt{3}\sin \frac{\pi x}{60}$

B. $f(x) = 4\sqrt{3} \sin \frac{\pi x}{30}$

C. $f(x) = -\frac{\sqrt{3}}{225} x^2 + \frac{4\sqrt{3}}{15} x$

D. $f(x) = -\frac{3}{200} x^2 + \frac{9}{10} x$
...
D. 若甲、乙两游客分别坐在 P, Q 两个座舱里, 且两人相隔 5 个座舱 (将座舱视为圆周上的点), 则劣弧 PQ 的长 $l = \frac{40\pi}{3}$ 米
...
A. $\left[\cos \frac{\pi}{4}\right] = 0$   
B. 函数 $y = \cos x - [\cos x]$ 有 3 个零点  
C. $y = [\cos x]$ 的最小正周期为 $2\pi$   
...
B. $\lambda(a\otimes b)=(\lambda a)\otimes b(\lambda\in\mathbf{R})$   
C. $(a+b)\otimes c=a\otimes c+b\otimes c$   
D. 若 e 是单位向量, 则 $\left|a\otimes e\right|\leqslant\left|a\right|+1$
...
A. 若 $a \gg b$ 且 $\mu a \gg \lambda b$ ，则 $\mu \geqslant \lambda$   
B. 若 $a=(2022,2024)$ , $b=(2023,2025)$ , 则 $a\ll b$   
C. 若 $a \gg b$ ，则对于任意向量 c，都有 $(a + c) \gg (b + c)$   
D. 若 $a \ll b$ ，则对于任意向量 c，都有 $a \cdot c \leqslant b \cdot c$
...
A. 若 $\overrightarrow{OP} = (x_{1}, y_{1})$ , $\overrightarrow{OQ} = (x_{2}, y_{2})$ , 则 $\overrightarrow{OP} + \overrightarrow{OQ} = (x_{1} + x_{2}, y_{1} + y_{2})$   
B. 若 $\overrightarrow{OP} = (x_{1}, y_{1}), \overrightarrow{OQ} = (x_{2}, y_{2})$ ，则 $\overrightarrow{OP} \cdot \overrightarrow{OQ} = x_{1}x_{2} + y_{1}y_{2}$   
C. 若 $P(x_{1},y_{1}),Q(x_{2},y_{2})$ ，则 $\vert PQ\vert = \sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2}$   
D. 若 $\theta = 60^{\circ}$ , 则以 $O$ 为圆心、1 为半径的圆的斜坐标方程为 $x^{2} + y^{2} - xy - 1 = 0$
...
A. 若 $\theta=60^{\circ}, P(2,-1)$ ，则 $\left|\overrightarrow{OP}\right|=\sqrt{3}$   
B. 若 $P(x_{1},y_{1}),Q(x_{2},y_{2})$ ，则 $\overrightarrow{OP} +\overrightarrow{OQ} = (x_1 + x_2,y_1 + y_2)$   
C. 若 $P(x,y)$ , $\lambda \in R$ , 则 $\lambda \overrightarrow{OP} = (\lambda x, \lambda y)$   
D. 若 $\overrightarrow{OP} = (x_{1}, y_{1})$ , $\overrightarrow{OQ} = (x_{2}, y_{2})$ , 则 $\overrightarrow{OP} \cdot \overrightarrow{OQ} = x_{1}x_{2} + y_{1}y_{2}$
...
A. $f(x) = 2\sin \left(x - \frac{\pi}{3}\right) - 1$

B. $f(x) = 2\sin \left(x - \frac{\pi}{3}\right) + 1$

C. $f(x) = 2\sin \left(2x - \frac{\pi}{3}\right) - 1$

D. $f(x) = 2\sin\left(2x - \frac{\pi}{3}\right) + 1$
...
C. $\left[\frac{\pi}{6},\frac{7\pi}{12}\right)$

D. $\left[\frac{\pi}{6},\frac{7\pi}{12}\right]$
...
B. $\sin \varphi = \frac{\sqrt{2}}{2}$

C. $f(x) = \tan (2x + \frac{\pi}{4})$

D. 函数 $f(x)$ 图象的对称中心是点 $\left(\frac{5\pi}{8}+\frac{k\pi}{2},0\right)(k\in\mathbf{Z})$
...
C. 直线 $x = \frac{7\pi}{6}$ 是曲线 $y = f(x)$ 的一条对称轴

D. 函数 $f(x - \frac{\pi}{6})$ 是奇函数
...
A. $\varphi = \frac{\pi}{6}$   
B. $\omega = 2$   
C. $f(x + \frac{\pi}{6})$ 为偶函数  
D. $f(x)$ 在区间 $\left[0, \frac{\pi}{2}\right]$ 上的最小值为 $-\frac{1}{2}$

2（多选）已知函数 $f(x) = A \sin (\omega x + \varphi) (A > 0, \omega > 0, 0 < \varphi < \pi)$ 的部分图象如图4中实线所示，图中圆 $C$ 与 $f(x)$ 的图象交于 $M, N$ 两点，且 $M$ 在 $y$ 轴上，则下列选项中正确的有（）

A. 函数 $f(x)$ 的最小正周期是 $\pi$   
B. 函数 $f(x)$ 在 $(- \frac{7\pi}{12}, -\frac{\pi}{3})$ 上单调递减  
C. 曲线 $y = f(x)$ 向左平移 $\frac{\pi}{12}$ 个单位长度后关于直线 $x = \frac{\pi}{2}$ 对称  
D. 若圆 C 的半径为 $\frac{5\pi}{12}$ ，则 $f(x)=\frac{\sqrt{3}\pi}{6}\sin(2x+\frac{\pi}{3})$
...
graph TD
    ...
    G --> I["横坐标伸长(A>1)或缩短(0<A<1)到原来的A倍"]
    J["y=Asin(ωx+φ)的图象"] --> K["纵坐标不变"]
    J --> L["横坐标变"]
    M["画出y=sin x的图象"] --> N["纵坐标不变"]
    M --> O["横坐标变为原来的1/ω倍"]
    P["y=sin ωx的图象"] --> Q["向左(φ>0)或向右(φ<0)"]
    P --> R["平移|φ|个单位长度"]
    S["y=sin(ωx+φ)的图象"] --> T["纵坐标不变"]
    S --> U["横坐标伸长(A>1)或缩短(0<A<1)到原来的A倍"]
    V["y=Asin(ωx+φ)的图象"] --> W["纵坐标不变"]
    V --> X["横坐标变"]
    Y["步骤1"] --> Z["方法一"]
    Z --> AA["步骤2"]
    AA --> AB["步骤3"]
...
A. $\left[\frac{19}{6},\frac{7}{2}\right)$

B. $\left(\frac{19}{6},\frac{7}{2}\right]$

C. $\left[\frac{7}{2},\frac{25}{6}\right)$

D. $\left(\frac{7}{2},\frac{25}{6}\right]$
...
A. $f(x) = \sqrt{2}\sin (x + \frac{\pi}{12})$

B. $f(x)=\sqrt{2}\sin(4x+\frac{\pi}{12})$

C. $f(x) = \sqrt{2}\sin (x - \frac{\pi}{12})$

D. $f(x) = \sqrt{2}\sin (4x - \frac{\pi}{12})$
...
| 3π/2 | 4 |
| 2π | 0 |
The chart displays a piecewise linear function with two local minima and one global minimum. The function is defined by the equation y = f(x).
</details>
...
graph TD
    ...
    A --> H["补充一"]
    A --> I["补充二"]
    B --> J["sin(α+k·2π)=sin α"]
    B --> K["cos(α+k·2π)=cos α"]
    B --> L["tan(α+k·2π)=tan α (其中k∈Z)"]
    C --> M["sin(π+α)=-sin α"]
    C --> N["cos(π+α)=-cos α"]
    C --> O["tan(π+α)=tan α"]
    D --> P["sin(-α)=-sin α"]
    ...
    G --> X["sin(π/2)+α)=cos α"]
    G --> Y["cos(π/2)+α)=-sin α"]
    H --> Z["sin(3π/2)-α)=-cos α"]
    H --> AA["cos(3π/2)-α)=-sin α"]
    I --> AB["sin(3π/2)+α)=-cos α"]
    I --> AC["cos(3π/2)+α)=sin α"]
```
</details>
...
A. $\frac{-7+4\sqrt{6}}{18}$

B. $\frac{-7-4\sqrt{6}}{18}$

C. $\frac{-7\sqrt{3}-4\sqrt{2}}{18}$

D. $\frac{-7\sqrt{3}+4\sqrt{2}}{18}$
...
3D geometric diagram showing a stepped column with labeled points A, B, C, and O (no text or symbols beyond labels)
</details>
...
A. 观测点 B 位于 A 的北偏东75°方向  
B. 当天 10:00 时, 该船到观测点 B 的距离为 $\sqrt{6}$ km  
C. 当船行驶至 A 处时, 该船到观测点 B 的距离为 $\sqrt{6}$ km  
D. 该船在由 C 行驶至 A 的这 5min 内行驶了 $\sqrt{2}$ km
...
B. $\overrightarrow{CO} \cdot \overrightarrow{CB} = 4$   
...
C. $\triangle ABE$ 的面积为 $\frac{\sqrt{3}}{5}$

D. P 在 $\triangle ABD$ 的外接圆上, 则 $PB + \frac{1}{2}PD$ 的最大值为 $\sqrt{7}$
...
A. 若 O 为 AD 中点, 则 $\overrightarrow{AO} = \frac{1}{2} (\overrightarrow{OB} + \overrightarrow{OC})$   
B. 若 O 为 AD 中点, 则 $\overrightarrow{OB} = \frac{3}{4}\overrightarrow{AB} - \frac{1}{2}\overrightarrow{AE}$   
C. 若 O 为 $\triangle ABC$ 的重心, 则 $\overrightarrow{OB} + \overrightarrow{OE} = 0$   
D. 若 O 为 $\triangle ABC$ 的外心, 且 BC = 4, 则 $\overrightarrow{OB} \cdot \overrightarrow{BC} = -8$
...
A. $\overrightarrow{AO} = \frac{1}{3}\overrightarrow{AB} +\frac{1}{3}\overrightarrow{AC}$

B. $\overrightarrow{AB} \cdot \overrightarrow{AC} \leqslant 3$

C. $\triangle ABC$ 的面积的最大值为 $3 \sqrt{6}$
...
Geometric diagram with circle, chords, and labeled points P, A, B, C, D, O, P₁, showing triangles and dashed auxiliary lines.
</details>
...
Geometric diagram of triangle ABC with internal points, perpendiculars, and dashed lines labeled O, H, D, E
</details>
...
Geometric diagram of a parallelogram ABCD with diagonals AC and BD intersecting inside
</details>
...
Geometric diagram with labeled points A, B, C, D, and P, showing triangles and directional arrows
</details>
...
A. $\sin\angle BAC\cdot\overrightarrow{OA}+\sin\angle ABC\cdot\overrightarrow{OB}+\sin\angle BCA\cdot\overrightarrow{OC}=0$

B. $\cos\angle BAC\cdot\overrightarrow{OA}+\cos\angle ABC\cdot\overrightarrow{OB}+\cos\angle BCA\cdot\overrightarrow{OC}=0$

C. $\tan \angle BAC \cdot \overrightarrow{OA} + \tan \angle ABC \cdot \overrightarrow{OB} + \tan \angle BCA \cdot \overrightarrow{OC} = 0$

D. $\sin 2\angle BAC\cdot \overrightarrow{OA} +\sin 2\angle ABC\cdot \overrightarrow{OB} +\sin 2\angle BCA\cdot \overrightarrow{OC} = 0$
...
Geometric diagram showing triangle ABC with internal point I and directional arrows
</details>
...
每月一季
专题论文卷
大华新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考新定义题第19题·高考前文选题
作文素材上 名
·时政热点
全方位增强试题特点，精选
论文选题方法：论文选题方法
...
论文选题方法：论文选题方法
论文选题方法：论文选题方法
论文选题方法：论文选题 方法论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论论<nl>
</details>
...
Cartoon star character wearing a blue patterned shirt and white pants, holding a pen, standing in front of a green chalkboard (no text or symbols visible)
</details>
