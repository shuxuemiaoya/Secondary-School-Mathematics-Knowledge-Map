...
$\quad$C. $-\frac{1}{3}+\frac{\sqrt{3}}{3}i$

$\quad$D. $-\frac{1}{3} - \frac{\sqrt{3}}{3} i$
...
$\quad$A. $z_{1} + z_{2}$ 在复平面内对应的点位于第二象限

$\quad$B. 若向量 $\overrightarrow{OA}, \overrightarrow{OB}$ 分别对应的复数为 $z_{1}$ ， $z_{2}$ ，则向量 $\overrightarrow{AB}$ 对应的复数为 3-4i

$\quad$C. 若 $z_{1}(a + i) = z_{2} + bi(a, b \in R)$ ，则 $ab = -3$

$\quad$D. 若复数 $z_{3} = x + yi(x, y \in R, i$ 为虚数单位)，且 $|z_{3}| = 1$ ，则 $|z_{3} - 3i|$ 的最大值为4
...
$\quad$A. $-\frac{1}{2} + \frac{\sqrt{3}}{2} i$

$\quad$B. $-1 + i$

$\quad$C. $-\frac{1}{2} - \frac{\sqrt{3}}{2} i$

$\quad$D. $-\frac{1}{4}+\frac{3}{4}i$
