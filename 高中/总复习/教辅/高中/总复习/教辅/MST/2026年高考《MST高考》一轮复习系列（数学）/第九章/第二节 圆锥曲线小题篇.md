...
$\quad$D. $\frac{x^{2}}{7}+\frac{y^{2}}{16}=1$
...
$\quad$A. $\frac{x^2}{4} +\frac{y^2}{9} = 1$

$\quad$B. $\frac{x^2}{9} +\frac{y^2}{3} = 1$

$\quad$C. $\frac{x^{2}}{25}+\frac{y^{2}}{9}=1$

$\quad$D. $\frac{x^{2}}{25}+\frac{y^{2}}{16}=1$
...
$\quad$C. $\frac{y^2}{16} -\frac{x^2}{9} = 1$

$\quad$D. $\frac{y^2}{9} -\frac{x^2}{16} = 1$
...
$\quad$A. 当 $\lambda=\frac{1}{2}$ 时，直线 CM 与直线 DN 斜率乘积为 $-\frac{1}{a^{2}}$   
$\quad$B. 当 $a = -1$ 时，存在点 $P$ ，使得 $|DP| = 2$   
$\quad$C. 当 a=2 时， $\triangle PAC$ 面积最大值为 $\frac{\sqrt{2}-1}{2}$   
$\quad$D. 若存在 $\lambda$ ，使得 $|DP| > 2$ ，则 $a \in (-\infty, -\sqrt{2}) \cup (\sqrt{2}, +\infty)$
...
$\quad$A. $\left[\frac{\sqrt{3}}{2},1\right)$

$\quad$B. $(0,\frac{\sqrt{2}}{2}]$
...
$\quad$A. $|PF_{1}| = a + m, \quad |PF_{2}| = a - m$

$\quad$B. 若 $\theta = 60^{\circ}$ ，则 $\frac{1}{e_1^2} + \frac{3}{e_2^2} = 4$

$\quad$C. 若 $\theta = 90^{\circ}$ , 则 $e_1^2 + e_2^2$ 的最小值为 2

$\quad$D. $\tan \frac{\theta}{2} = \frac{n}{b}$
...
$\quad$A. 当点 $C$ 为线段 $PQ$ 的中点时, 直线 $l$ 的斜率为 $\sqrt{3}$

$\quad$B. 若 $A(-1,0)$ ，则 $\angle QF_{2}A = 2\angle QAF_{2}$

$\quad$C. $\left|PF_{1}\right|\cdot\left|PF_{2}\right|>\left|PO\right|^{2}$

$\quad$D. 若直线 $l$ 的斜率为 $\frac{2\sqrt{3}}{3}$ ，且 $B(0, \sqrt{3})$ ，则 $|PF_1| + |QF_1| = |PB| + |QB|$
...
$\quad$A. 若 $\overrightarrow{AF_{1}}=2\overrightarrow{F_{1}B}$ ，则 $l_{1}$ 的斜率 $k=\frac{\sqrt{6}}{2}$

$\quad$B. $|AF_{1}| + 4|BF_{1}|$ 的最小值为 $\frac{27}{4}$

$\quad$C. 以 $AF_{1}$ 为直径的圆与圆 $x^{2} + y^{2} = 4$ 相切

$\quad$D. 若 $l_{1} \perp l_{2}$ , 则四边形 $ADBC$ 面积的最小值为 $\frac{288}{49}$
...
$\quad$A. $\frac{28\sqrt{10}}{5}$

$\quad$B. $\frac{28\sqrt{10}}{10}$

$\quad$C. $\frac{28\sqrt{5}}{5}$

$\quad$D. $\frac{56\sqrt{5}}{5}$

【例 5】(2025·T8·多选)已知 $F(2,0)$ 是抛物线 $C: y^{2} = 2px$ 的焦点，M 是 C 上的点，O 为坐标原点. 则（）

$\quad$A. $p = 4$   
$\quad$B. $|MF| \geqslant |OF|$   
$\quad$C. 以 $M$ 为圆心且过 $F$ 的圆与 $C$ 的准线相切  
$\quad$D. 当 $\angle OFM = 120^{\circ}$ 时， $\triangle OFM$ 的面积为 $2\sqrt{3}$
...
$\quad$C. $|OP|\cdot|OQ|>|OA|^{2}$

$\quad$D. $|BP|\cdot|BQ|>|BA|^{2}$
...
$\quad$A. $\frac{2\sqrt{3}}{3}$ 或 $\sqrt{3}$

$\quad$B. 2 或 $\sqrt{3}$

$\quad$C. $\sqrt{3}$ 或 $2\sqrt{3}$

$\quad$D. 2 或 $\frac{2\sqrt{3}}{3}$
...
$\quad$B. 延长 $AO$ 交直线 $x = -\frac{1}{4}$ 于点 $D$ ，则 $D$ ， $B$ ， $Q$ 三点共线

$\quad$C. $\left|AB\right|=\frac{25}{16}$

$\quad$D. 若 $PB$ 平分 $\angle ABQ$ ，则 $m = \frac{41}{16}$
...
$\quad$A. $|PF| = x_0 + \frac{p}{2}$

$\quad$B. 以 $PF$ 为直径的圆与 $y$ 轴相切

$\quad$C. $|PF| = \frac{2}{3} p$

$\quad$D. 直线 $OP$ 的斜率为 $\frac{2\sqrt{3}}{3} (O$ 为原点)
...
$\quad$A. 当 $\varphi = \frac{\pi}{4}, \gamma = \frac{\pi}{6}$ 时， $\Gamma$ 是椭圆

$\quad$B. 当 $\varphi = \frac{\pi}{3}, \gamma = \frac{\pi}{6}$ 时， $\Gamma$ 是双曲线

$\quad$C. 当 $\varphi = \frac{\pi}{4}, \gamma = \frac{\pi}{4}$ 时， $\Gamma$ 是抛物线

$\quad$D. 当 $\varphi = \frac{\pi}{3}, \gamma = \frac{\pi}{4}$ 时， $\Gamma$ 是圆
...
$\quad$A. 若 E 为面 $A_{1}B_{1}C_{1}D_{1}$ 内一点，则 E 点的轨迹长度为 $\frac{\pi}{2}$

$\quad$B. 过 $AB$ 作面 $\alpha$ 使得 $DE \perp \alpha$ , 若 $E \in \alpha$ , 则 $E$ 的轨迹为椭圆的一部分

$\quad$C. 若 $F$ ， $G$ 分别为 $A_{1}D_{1}$ ， $B_{1}C_{1}$ 的中点， $DE$ 与面 $FGAB$ ，则 $E$ 的轨迹为双曲线的一部分

$\quad$D. 若 $F$ ， $G$ 分别为 $A_{1}D_{1}$ ， $B_{1}C_{1}$ 的中点， $DE$ 与面FGAB所成角为 $\theta$ ，则 $\sin \theta$ 的范围为 $[\frac{\sqrt{10}}{10},\frac{3\sqrt{10}}{10} ]$
