...
B. 若过点 O 的直线交 C 于 A、B 两点 (A、B 与 M 均不重合)，则 $k_{MA}k_{MB}=\frac{1}{3}$   
C. 若点 $Q(8,1)$ ， $M$ 在双曲线 $C$ 的上支，则 $\left|MF_2\right| + \left|MQ\right|$ 最小值为 $2 + \sqrt{65}$   
D. 过 $F_{1}$ 的直线 l 交 C 于 G、H 不同两点，若 $|GH|=7$ ，则 l 有 4 条
...
A. $\Delta ABF_{2}$ 的周长为定值

B. $AB$ 的长度最小值为 1

C. 若 $AB \perp AF_{2}$ , 则 $\lambda = 3$
...
A. $\triangle F_{2}MN$ 是等边三角形

B. 双曲线 $C$ 的离心率为 $\sqrt{7}$

C. 双曲线 C 的渐近线方程为 $y = \pm \sqrt{6}x$

D. 点 $F_{1}$ 到直线 $\sqrt{6} x - y = 0$ 的距离为 $\sqrt{6} a$
...
A. $\overrightarrow{OA} \cdot \overrightarrow{OB} = -\frac{3}{4} p^2$

B. $y_{1}y_{2} = -p^{2}$

C. $x_{1}x_{2}=\frac{p^{2}}{4}$

D. $\frac{1}{|FA|} +\frac{1}{|FB|} = \frac{2}{p}$
...
D. $\angle AMP \leqslant \frac{\pi}{4}$
...
B. 若 $|PF| = 7$ ，则 $\Delta PMF$ 的面积为 $2\sqrt{3} - \frac{3}{2}$

C. $|PF| - |PM|$ 的最大值为 $\sqrt{10}$

D. $\Delta PMF$ 的周长的最小值为 $7 + \sqrt{10}$
...
D. 若点 $T$ 坐标为 $(1,0)$ ，直线 $PT$ 与 $C$ 相切，则 $|PF_{2}| = 12$
...
A. 四边形 $HF_{1}PF_{2}$ 的周长为 $4 + \sqrt{5}$

B. 直线 $A_{1}P$ ， $A_{2}P$ 的斜率之积为 $-\frac{3}{4}$

C. $\left|F_{1}G\right|:\left|F_{2}G\right|=3:2$

D. 四边形 $HF_{1}PF_{2}$ 的面积为 2
