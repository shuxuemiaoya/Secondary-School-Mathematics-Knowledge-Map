...
$\quad$A. $EF$ 与 $A_{1}C_{1}$ 平行

$\quad$B. $BC_{1}$ 与 $AB_{1}$ 所成角大小为 $\frac{\pi}{3}$

$\quad$C. $EF$ 与 $BB_{1}$ 垂直
...
$\quad$A. $\left[\frac{\sqrt{3}}{3},1\right]$

$\quad$B. $[\frac{\sqrt{6}}{3}, 1]$

$\quad$C. $\left[\frac{\sqrt{6}}{3},\frac{2\sqrt{2}}{3}\right]$

$\quad$D. $[\frac{2\sqrt{2}}{3},1]$
...
$\quad$B. $1.2 \times 10^{9} m^{3}$

$\quad$C. $1.4 \times 10^{9} m^{3}$

$\quad$D. $1.6 \times 10^{9} m^{3}$
...
$\quad$A. $\overrightarrow{EF} = \frac{1}{2} (\overrightarrow{AB} +\overrightarrow{AC} -\overrightarrow{AD})$

$\quad$B. $EF = \frac{\sqrt{2}}{2}$

$\quad$C. $BC \perp$ 平面 $AEF$

$\quad$D. $AE$ 和 $CF$ 夹角的正弦值为 $\frac{2}{3}$
...
$\quad$A. 四棱锥 $C - A_{1}B_{1}BA$ 为“阳马”

$\quad$B. 四面体 $A_{1}CC_{1}B_{1}$ 为“鳖臑”

$\quad$C. 四棱锥 $B - A_{1}ACC_{1}$ 体积的最大值为 $\frac{2}{3}$

$\quad$D. 过 A 点分别作 $AE \perp A_{1}B$ 于点 E， $AF \perp A_{1}C$ 于点 F，则 $EF \perp A_{1}B$
...
$\quad$A. 存在点 $G$ ，使直线 $B_{1}C \perp$ 平面 $EFG$   
$\quad$B. 存在点 $G$ ，使平面 $EFG //$ 平面 $BDC_{1}$   
$\quad$C. 三棱锥 $A_{1} - EFG$ 的体积为定值  
$\quad$D. 平面 $EFG$ 截正方体所得截面的最大面积为 $\frac{3\sqrt{3}}{4}$
...
$\quad$A. 在翻折过程中, 恒有直线 $AD / /$ 平面 $BCF$

$\quad$B. 存在某一位置，使得 $CD / /$ 平面ABFE

$\quad$C. 存在某一位置，使得 $BF // CD$

$\quad$D. 存在某一位置，使得 $DE \perp$ 平面ABFE
...
$\quad$A. 存在某个位置，使直线 $AF$ 与 $BD$ 垂直  
$\quad$B. 存在某个位置，使直线 $AD$ 与 $BF$ 垂直  
$\quad$C. 存在某个位置，使直线 $AB$ 与 $DA$ 垂直  
$\quad$D. 存在某个位置，使直线 $AB$ 与 $DF$ 垂直

【训练 4】已知平面四边形 ABCD，连接对角线 BD，得到等边三角形 ABD 和直角三角形 BCD，且 AB = 3， $\angle BDC = \frac{\pi}{2}$ ， $BC = 3\sqrt{2}$ ，将平面四边形 ABCD 沿对角线 BD 翻折，得到四面体 $A'BC'D$ ，则当四面体 $A'BC'D$ 的体积最大时，该四面体的外接球的表面积为（）
...
$\quad$A. $PD \perp CD_{1}$   
$\quad$B. 三棱锥 $C_{1} - A_{1}PD$ 的体积为定值  
$\quad$C. $(CP + PA_{1})$ 的最小值是 $\frac{\sqrt{2} + \sqrt{3}}{2}$   
$\quad$D. 如果点 $P$ 是线段 $AB_{1}$ 的中点，则平面 $PDN$ 截正方体所得的截面周长为 $\sqrt{5} + \frac{\sqrt{17}}{2}$
