...
$\quad$D. $f(x)=\left|\log_{\frac{1}{2}}x\right|$
...
$\quad$A. $f(x)\cdot g(x)$ 是偶函数

$\quad$B. $|f(x)| \cdot g(x)$ 是奇函数

$\quad$C. $f(x) \cdot |g(x)|$ 是奇函数

$\quad$D. $|f(x) \cdot g(x)|$ 是奇函数
...
$\quad$C. $(1,\frac{3}{2}]\bigcup[-\frac{1}{2},\frac{1}{3})$

$\quad$D. $(- \infty, \frac{1}{3}) \cup (1, +\infty)$
...
$\quad$B. $f(x)$ 是单调递增函数  
$\quad$C. $f(x)$ 是单调递减函数  
$\quad$D. 不等式 $f(2t + 1) + f(t - 5) \leqslant 0$ 的解集为 $\{t \mid t \geqslant \frac{4}{3}\}$
