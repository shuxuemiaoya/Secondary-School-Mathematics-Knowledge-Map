...
A. $[2k\pi + \frac{3}{8}\pi, 2k\pi + \frac{7}{8}\pi](k \in Z)$

B. $[k\pi +\frac{3}{8}\pi ,k\pi +\frac{7}{8}\pi ](k\in Z)$

C. $[k\pi -\frac{1}{8}\pi ,k\pi +\frac{3}{8}\pi ](k\in Z)$

D. $[k\pi -\frac{5}{8}\pi ,k\pi -\frac{1}{8}\pi ](k\in Z)$
...
C. $\left[\frac{11}{4},4\right]$

D. $\left(\frac{11}{4},6\right]$
...
A. $f(x)$ 为周期函数  
B. 存在 $t \in R$ ，使得 $y = f(x)$ 的图象关于 $x = t$ 对称  
C. $f(x)$ 在区间 $\left(\frac{\pi}{3}, \frac{3\pi}{4}\right)$ 上单调递减  
D. $f(x)$ 的最大值为 2
