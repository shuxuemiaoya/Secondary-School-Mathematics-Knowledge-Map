...
$\quad$B. $f(x) = |\sin \frac{\pi}{2} x|$

$\quad$C. $f(x) = \cos 2\pi x$

$\quad$D. $f(x) = \tan \pi x$

【训练4】已知 $f(x) = \sin (2x - \frac{\pi}{4})$ ，则 $f(x)$ 的最小正周期和一个单调增区间分别为（）

$\quad$A. $\pi, \left[-\frac{\pi}{4}, \frac{\pi}{4}\right]$

$\quad$B. $\pi, [-\frac{\pi}{8}, \frac{3\pi}{8}]$

$\quad$C. $2\pi$ ， $\left[-\frac{\pi}{4}, \frac{3\pi}{4}\right]$

$\quad$D. $2\pi$ ， $\left[-\frac{\pi}{4}, \frac{\pi}{4}\right]$
...
$\quad$A. $y = 2\sin (2x - \frac{\pi}{6})$

$\quad$B. $y = 2\sin (2x - \frac{\pi}{3})$

$\quad$C. $y = 2 \sin(x + \frac{\pi}{6})$

$\quad$D. $y = 2\sin \left(x + \frac{\pi}{3}\right)$
...
$\quad$A. 各点的横坐标缩短到原来的 $\frac{1}{2}$ , 再向左平移 $\frac{\pi}{3}$ 个单位长度

$\quad$B. 各点的横坐标缩短到原来的 $\frac{1}{2}$ , 再向左平移 $\frac{\pi}{6}$ 个单位长度

$\quad$C. 各点的横坐标伸长到原来的 2 倍, 再向左平移 $\frac{\pi}{3}$ 个单位长度

$\quad$D. 各点的横坐标伸长到原来的 2 倍, 再向左平移 $\frac{\pi}{6}$ 个单位长度

【训练 3】为了得到函数 $y = \sin(2x + \frac{\pi}{3})$ 的图象，只需要把函数 $y = \cos x$ 上所有的点（）

$\quad$A. 向右平移 $\frac{\pi}{6}$ 个单位，横坐标变为原来的 $\frac{1}{2}$ 倍  
$\quad$B. 向左平移 $\frac{\pi}{6}$ 个单位, 横坐标变为原来的 2 倍  
$\quad$C. 横坐标变为原来的 $\frac{1}{2}$ 倍, 向左平移 $\frac{\pi}{12}$ 个单位  
...
$\quad$A. $(0,\frac{2}{3})\bigcup[\frac{5}{3},\frac{8}{3}]$

$\quad$B. $\left(\frac{2}{3},\frac{5}{3}\right]\bigcup\left[2,\frac{8}{3}\right]$

$\quad$C. $\left[\frac{5}{3},2\right)\bigcup \left[\frac{8}{3},\frac{11}{3}\right]$

$\quad$D. $(0,2]\bigcup[\frac{8}{3},\frac{11}{3}]$
...
$\quad$C. $\left[\frac{7}{3},\frac{26}{9}\right]$
