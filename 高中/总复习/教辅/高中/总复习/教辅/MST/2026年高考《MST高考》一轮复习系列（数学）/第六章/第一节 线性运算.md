...
$\quad$A. $\frac{1}{2}\vec{a} +\frac{1}{2}\vec{b} +\vec{c}$

$\quad$B. $\frac{1}{2}\vec{a} -\frac{1}{2}\vec{b} +\vec{c}$

$\quad$C. $\vec{a}-\frac{1}{2}\vec{b}+\frac{1}{2}\vec{c}$

$\quad$D. $\vec{a}+\frac{1}{2}\vec{b}+\vec{c}$

【例 2】（多选）下列各式中结果为零向量的为( )

$\quad$A. $\overrightarrow{OA} + \overrightarrow{OC} + \overrightarrow{BO} + \overrightarrow{CO}$

$\quad$B. $\overrightarrow{AB} +\overrightarrow{MB} +\overrightarrow{BO} +\overrightarrow{OM}$

$\quad$C. $\overrightarrow{AB}-(\overrightarrow{AC}-\overrightarrow{BD})-\overrightarrow{CD}$

$\quad$D. $\overrightarrow{AB} +\overrightarrow{BC} +\overrightarrow{CA}$
...
$\quad$A. $3\vec{m} - 2\vec{n}$

$\quad$B. $-2\vec{m} + 3\vec{n}$

$\quad$C. $3\vec{m} + 2\vec{n}$

$\quad$D. $2\vec{m} + 3\vec{n}$
