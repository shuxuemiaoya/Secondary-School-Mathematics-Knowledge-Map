...
Black-and-white photo of a person in formal attire operating machinery at an indoor event (no visible text or symbols)
</details>
...
Ornate hexagonal decorative pattern with intricate floral and geometric motifs (no text or symbols)
</details>
...
Geometric diagram of triangle ABC with internal points D, E, F, O and dashed lines indicating segments or auxiliary lines.
</details>
...
Geometric diagram of a circle with inscribed triangle ABC and internal points D, E, O labeled
</details>
...
A. 若 $P$ 是 $\Delta ABC$ 的重心, 则有 $\overrightarrow{PA} + \overrightarrow{PB} + \overrightarrow{PC} = \overrightarrow{0}$   
B. 若 $a\overrightarrow{PA} + b\overrightarrow{PB} + c\overrightarrow{PC} = \vec{0}$ 成立，则 $P$ 是 $\Delta ABC$ 的内心  
C. 若 $\overrightarrow{AP} = \frac{2}{5}\overrightarrow{AB} +\frac{1}{5}\overrightarrow{AC}$ ，则 $S_{\triangle ABP}:S_{\triangle ABC} = 2:5$   
D. 若 $P$ 是 $\Delta ABC$ 的外心， $A = \frac{\pi}{4}$ ， $\overrightarrow{PA} = m\overrightarrow{PB} + n\overrightarrow{PC}$ ，则 $m + n \in [-\sqrt{2}, 1)$
...
A. 若 $O$ 为 $\Delta ABC$ 的重心，则 $\lambda + \mu = \frac{2}{3}$

B. 若 $O$ 为 $\Delta ABC$ 的内心，则 $\lambda + \mu = \frac{2}{5}$

C. 若 $O$ 为 $\Delta ABC$ 的外心，则 $\lambda + \mu = \frac{9}{10}$

D. 若 $O$ 为 $\Delta ABC$ 的垂心，则 $\lambda + \mu = \frac{1}{5}$
...
Geometric diagram of rectangle ABCD with diagonals and internal point P, showing intersection O and dashed line OP
</details>
