...
$\quad$B. $D$ 可能是线段 $AB$ 的中点

$\quad$C. C、D 可能同时在线段 AB 上 
$\quad$D.
...
由于 $\frac{x^{2}}{a^{2}}-\frac{y^{2}}{a^{2}}=1$ ，令 $\left\{\begin{aligned}x'&=\frac{x}{a}-\frac{y}{a}\\ y'&=\frac{x}{a}+\frac{y}{a}\end{aligned}\right.$ ，则 $x'y'=1$ ，由于(1,0)逆时针旋转 $45^{\circ}$ 后得到点 $(\frac{\sqrt{2}}{2},\frac{\sqrt{2}}{2})$ ，(0,1)逆时针旋转 $45^{\circ}$ 后得到点 $(- \frac{\sqrt{2}}{2},\frac{\sqrt{2}}{2})$ ，所以 $\left\{\begin{aligned}x'&=\frac{x}{a}-\frac{y}{a}=\frac{\sqrt{2}}{2}(\frac{\sqrt{2}x}{a}-\frac{\sqrt{2}y}{a})\\ y'&=\frac{x}{a}+\frac{y}{a}=\frac{\sqrt{2}}{2}(\frac{\sqrt{2}x}{a}+\frac{\sqrt{2}y}{a})\end{aligned}\right.$ 变换是将原来 $P(x,y)$ 横坐标和纵坐标缩小 $\frac{a}{\sqrt{2}}$ 倍后逆时针旋转 $45^{\circ}$ 得来。
...
压缩长轴后点的坐标变化： $A(x_{0},y_{0})\rightarrow A'(\frac{b}{a}x_{0},y_{0})$ ，纵坐标不变，横坐标缩小 $\frac{b}{a}$ 倍.
