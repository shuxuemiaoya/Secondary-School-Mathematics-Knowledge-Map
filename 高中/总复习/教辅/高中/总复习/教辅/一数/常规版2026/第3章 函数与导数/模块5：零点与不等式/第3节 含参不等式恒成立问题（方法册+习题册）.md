...
直线 $l_{1}$ 与 $y=2\ln x$ 相切，设切点为 $(x_{0},2\ln x_{0})$ ，因为 $(2\ln x)^{\prime}=\frac{2}{x}$ ，所以 $\left\{\begin{aligned}\frac{2}{x_{0}}&=a_{1}\\ 2\ln x_{0}&=a_{1}x_{0}+2\end{aligned}\right.$ ，解得： $a_{1}=\frac{2}{e^{2}}$ ；再求 $l_{2}$ 的斜率 $a_{2}$ ， $l_{2}$ 与曲线 $y=-x^{2}-2x(x\leq0)$ 相切， $\left\{\begin{aligned}y=a_{2}x+2\\ y=-x^{2}-2x\end{aligned}\right.\Rightarrow x^{2}+(a_{2}+2)x+2=0$ ，
...
解析：由 $x_{1}>x_{2}$ 知 $x_{1}-x_{2}>0$ ，所以 $\frac{e^{2x_{1}}-e^{2x_{2}}}{x_{1}-x_{2}}>me^{x_{1}+x_{2}}\Leftrightarrow\frac{e^{x_{1}-x_{2}}-e^{x_{2}-x_{1}}}{x_{1}-x_{2}}>m\Leftrightarrow e^{x_{1}-x_{2}}-e^{x_{2}-x_{1}}>m(x_{1}-x_{2})$ ①，
...
C. $\left[\frac{1}{e},1\right)\cup(1,e)$
