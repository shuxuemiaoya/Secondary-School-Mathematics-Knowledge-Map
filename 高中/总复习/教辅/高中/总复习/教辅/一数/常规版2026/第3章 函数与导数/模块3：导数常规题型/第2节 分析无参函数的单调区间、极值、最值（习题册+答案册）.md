...
$\quad$A. 当 $x < 0$ 时， $f(x) > 0$   
$\quad$B. $f(x)$ 在 $(1, +\infty)$ 上单调递增  
$\quad$C. $f(x)$ 的极大值为 1  
$\quad$D. $f(x)$ 的极大值为 $4\mathrm{e}^{\frac{3}{2}}$

##### 1. AC

<span class="fake-tag">解析</span>A项，当 $x < 0$ 时， $2x - 1 < 0$ ， $x - 1 < 0$ ， $\mathrm{e}^x > 0$ ，

所以 $f(x) = \frac{\mathrm{e}^x(2x - 1)}{x - 1} >0$ ，故A项正确；

B、C、D三个选项涉及单调性和极值，可统一分析，

$\begin{array}{l} f ^ {'} (x) = \frac {[ \mathrm{e} ^ {x} (2 x - 1) + 2 \mathrm{e} ^ {x} ] (x - 1) - \mathrm{e} ^ {x} (2 x - 1)}{(x - 1) ^ {2}} \\ = \frac {\mathrm{e} ^ {x} (2 x ^ {2} - 3 x)}{(x - 1) ^ {2}} = \frac {x (2 x - 3) \mathrm{e} ^ {x}}{(x - 1) ^ {2}}, \quad x \neq 1, \\ \end{array}$

所以 $f'(x) > 0\Leftrightarrow x <   0$ 或 $x > \frac{3}{2}$ ， $f'(x) <   0\Leftrightarrow 0 <   x <   1$ 或
...
$\quad$A. $f(0) = 0$   
$\quad$B. 当 $x < 0$ 时, $f(x) = -(x^2 - 3)e^{-x} - 2$   
$\quad$C. $f(x)\geq 2$ ，当且仅当 $x\geq \sqrt{3}$   
$\quad$D. $x = -1$ 是 $f(x)$ 的极大值点

##### 2. ABD

<span class="fake-tag">解析</span>A项，因为 $f(x)$ 是定义在 $\mathbf{R}$ 上的奇函数，
...
所以 $f'(x) > 0\Leftrightarrow 0 <   x <   2$ ， $f'(x) <   0\Leftrightarrow x <   0$ 或 $x > 2$
...
$f ^ {' '} (x) = \frac {2}{1 + x} + \frac {1 + x - x}{(1 + x) ^ {2}} = \frac {3 + 2 x}{(1 + x) ^ {2}} > 0,$
...
设 $g(x) = x - 1 - \ln x$ ， $x > 0$ ，则 $g'(x) = 1 - \frac{1}{x} = \frac{x - 1}{x}$
