...
令 $g(x) = \ln x - \frac{1}{x} -\frac{1}{2} +\mathrm{e}^{1 - x} + \frac{1}{2x^2},$ $x > 0$ ，则 $g^{\prime}(x) = \frac{1}{x} +\frac{1}{x^{2}} -\mathrm{e}^{1 - x} - \frac{1}{x^{3}} = \frac{x^{2} + x - 1}{x^{3}} -\mathrm{e}^{1 - x} = \mathrm{e}^{1 - x}\left(\frac{x^2 + x - 1}{x^3}\mathrm{e}^{x - 1} - 1\right),$ （经尝试，无法直接判断 $g^{\prime}(x)$ 的正负，考虑继续求导，直接求导显然比较复杂，观察发现 $g^{\prime}(x)$ 的正负只由 $\frac{x^2 + x - 1}{x^3}\mathrm{e}^{x - 1} - 1$ 决定，故只需把这部分单独拿出来求导分析）

设 $h(x) = \frac{x^2 + x - 1}{x^3}\mathrm{e}^{x - 1} - 1$ ， $x > 0$ ，则 $h^{\prime}(x) = \frac{(2x + 1)x^{3} - 3x^{2}(x^{2} + x - 1)}{x^{6}}\mathrm{e}^{x - 1} + \frac{x^{2} + x - 1}{x^{3}}\mathrm{e}^{x - 1} = \frac{x^{3} - 3x + 3}{x^{4}}\mathrm{e}^{x - 1},$
...
又 $f^{\prime}(1) = -1 < 0$ ， $f^{\prime}(\mathrm{e}) = 1 - \frac{1}{\mathrm{e}} >0$ ，所以 $f^{\prime}(x)$ 在 $(0, + \infty)$ 上有唯一的零点 $x_0$ ，且 $1 < x_0 < \mathrm{e}$
...
则 $F^{\prime}(x) = 2[-\mathrm{e}^{x} + (1 - x)\mathrm{e}^{x}] - 1 = -2xe^{x} - 1$ ， $F''(x) = -2(\mathrm{e}^x +x\mathrm{e}^x) = -2(1 + x)\mathrm{e}^x$

所以 $F''(x) > 0 \Leftrightarrow x < -1$ ， $F''(x) < 0 \Leftrightarrow -1 < x < 0$ ，故 $F'(x)$ 在 $(- \infty, -1)$ 上单调递增，在 $(-1, 0)$ 上单调递减，

所以 $F^{\prime}(x)\leq F^{\prime}(-1) = \frac{2}{\mathrm{e}} -1 < 0$ ，从而 $F(x)$ 在 $(-\infty ,0)$ 上单调递减，故 $F(x) > F(0) = 0$ 成立，
