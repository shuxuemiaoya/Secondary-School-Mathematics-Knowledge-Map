...
<span class="fake-tag">解析</span>已知直线的倾斜角，代公式 $S = \frac{p^2}{2\sin\alpha}$ 即可求 $\triangle AOB$ 的面积，由题意， $p = \frac{3}{2}$ ，直线 $AB$ 的倾斜角 $\alpha = 30^\circ$ ，
...
<span class="fake-tag">解析</span>如图，过 $B$ 作 $BD \perp l$ 于 $D$ ，直线 $AF$ 的倾斜角为 $120^{\circ}$ ，所以 $\angle AFO = \angle ABD = 60^{\circ}$
...
<span class="fake-tag">解析</span>抛物线 $C$ 的焦点为 $F\left(\frac{3}{2},0\right)$ ，准线为 $l:x = -\frac{3}{2}$
