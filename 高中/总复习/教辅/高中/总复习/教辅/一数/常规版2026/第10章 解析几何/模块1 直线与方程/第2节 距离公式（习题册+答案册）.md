...
<span class="fake-tag">解析</span>已知两直线平行，可先由 $A_{1}B_{2} = A_{2}B_{1}$ 求出 $m$
...
<span class="fake-tag">解析</span>已知 $A, B, C$ 的坐标求面积，不妨由两点距离公式算 $\vert AB\vert$ ，作为底边，点 $C$ 到直线 $AB$ 的距离作为高，
...
设直线 $l:3x - 4y + 2m = 0$ 与直线 $l':6x - my + 1 = 0$ 平行，则点 $A(a^{2},3a)$ 到 $l$ 的距离的最小值为（）
...
<span class="fake-tag">解析</span>条件有两直线平行，可由 $A_{1}B_{2} = A_{2}B_{1}$ 求参数 $m$

因为 $l / / l'$ ，所以 $3 \times (-m) = 6 \times (-4)$ ，故 $m = 8$ ，经检验，

$l$ 与 $l'$ 不重合，所以 $l$ 的方程为 $3x - 4y + 16 = 0$
...
<span class="fake-tag">解析</span>看到 $|x + y + 2|$ ，想到点到直线的距离公式，但还缺分母部分，于是凑分母，
...
<span class="fake-tag">解析</span>对于等腰三角形，需先找到谁是底，谁是腰，才能进一步翻译，故先画图分析，
