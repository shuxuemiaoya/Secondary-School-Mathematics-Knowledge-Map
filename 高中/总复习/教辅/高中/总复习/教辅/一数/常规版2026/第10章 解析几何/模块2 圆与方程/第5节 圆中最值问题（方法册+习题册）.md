...
解析：本题圆心是动点，先求出圆心的运动轨迹，设圆心为 $P(x, y)$ ，记 $Q(3, 4)$ ，
...
解析：在 $x + y + 2 = 0$ 中令 $x = 0$ 得 $y = -2$ ，令 $y = 0$ 得 $x = -2$ ，所以 $A(-2,0)$ ， $B(0,-2)$ ，故 $\vert AB\vert = 2\sqrt{2}$ 记 $\triangle ABP$ 的 $AB$ 边上的高为 $h$ ，则 $S_{\triangle ABP} = \frac{1}{2}\vert AB\vert \cdot h = \sqrt{2}h$
