...
解析：点 $P$ 与圆 $C$ 的位置关系不同，求切线的方法也不同，故先判断 $P$ 与圆 $C$ 的位置关系，
...
解析：如图， $\left|PO\right|=\sqrt{3^{2}+3^{2}}=3\sqrt{2}$ ，
...
解析：圆 $C$ 关于直线 $l$ 对称 $\Rightarrow$ 圆心 $C(2, - 1)$ 在直线 $l$ 上
