...
<span class="fake-tag">解析</span>: $B$ 在椭圆上运动, $\vert OB\vert$ 可通过设 $B$ 的坐标来算,
...
<span class="fake-tag">解析</span>先把椭圆的方程化为标准方程，找到 $a, b, c$
...
<span class="fake-tag">解析</span>设 $P(x,y)$ 为椭圆上一点， $\left|PA\right|^2 = (x - a)^2 +y^2$ ①，
...
<span class="fake-tag">解析</span>如图，点 $Q$ 可以看成直线 $AQ$ 和 $BQ$ 的交点，于是写出这两条直线的方程，联立求交点，
...
<span class="fake-tag">解析</span>如图，原点 O 在以 PQ 为直径的圆外可翻译成 $\overrightarrow{OP} \cdot \overrightarrow{OQ} > 0$ ，于是设 P，Q 的坐标，计算 $\overrightarrow{OP} \cdot \overrightarrow{OQ}$ ，
