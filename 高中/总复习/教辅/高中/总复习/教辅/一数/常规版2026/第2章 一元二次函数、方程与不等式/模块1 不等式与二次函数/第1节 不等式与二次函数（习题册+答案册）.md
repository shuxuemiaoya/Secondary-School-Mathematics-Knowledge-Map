...
$\quad$A. 若 $a > b$ ， $c > d$ ，则 $a - d > b - c$   
$\quad$B. 若 $a > b$ ， $c > d$ ，则 $ac > bd$   
$\quad$C. 若 $a > b$ ， $c > d > 0$ ，则 $\frac{a}{d} >\frac{b}{c}$   
$\quad$D. 若 $ab > 0$ ， $bc - ad > 0$ ，则 $\frac{c}{a} > \frac{d}{b}$

##### 1. AD

<span class="fake-tag">解析</span>A项，结论中 $d$ 和 $c$ 前面都有负号，故考虑在 $c > d$ 两端乘以-1，朝目标靠拢，
...
$\quad$B. $\frac{1}{ab} >\frac{1}{bc}$

$\quad$C. $ab^{2} < cb^{2}$

$\quad$D. $\frac{c - a}{c - b} > 1$

##### 2. AD

<span class="fake-tag">解析</span>a，b，c 关系清晰，可先取特值看能否排除选项，
...
<span class="fake-tag">解析</span>只说有根，没规定几个根，考虑参变分离，
...
<span class="fake-tag">解析</span>先求解 $(x - a)(x - 2) > 0$ ， $a$ 与2的大小不定，需讨论，
...
<span class="fake-tag">解析</span>规定了 $(2, +\infty)$ 上根的个数为 2，故考虑画二次函数的图象来看，
...
<span class="fake-tag">解析</span>观察发现解集的端点都含参，但差值不变，故可由韦达定理求出 $\left|x_{1}-x_{2}\right|$ ，从而建立方程求a，
...
<span class="fake-tag">解析</span>平方项系数为字母，先讨论其等于0的情形，
...
<span class="fake-tag">解析</span>由题意， $f'(x)=\frac{a}{x}-\frac{b}{x^{2}}-\frac{2c}{x^{3}}=\frac{ax^{2}-bx-2c}{x^{3}}(x>0)$

函数 $f(x)$ 既有极大值，又有极小值，所以 $f'(x)$ 在 $(0, + \infty)$ 上有两个变号零点，
