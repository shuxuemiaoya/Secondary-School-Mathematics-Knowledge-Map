...
解析：求圆锥的体积还差底面半径 $r$ ，我们先翻译已知的侧面积相等，建立方程求 $r$ ，
...
解析：要算正四棱台的体积，还差高，已知侧棱长，可在包含侧棱的截面 $BDD_{1}B_{1}$ 中来分析，
...
Abstract geometric line drawing of stacked 3D shapes (no text or symbols)
</details>
