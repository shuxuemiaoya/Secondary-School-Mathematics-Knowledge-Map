...
$f^{\prime}(x) < 0 \Leftrightarrow 1 < x < -\frac{a}{2}$ ，所以 $f(x)$ 在 $(- \infty, 1)$ 上单调递增，
...
③当 $a > -2$ 时， $-\frac{a}{2} < 1$ ，所以 $f^{\prime}(x) > 0\Leftrightarrow x <   - \frac{a}{2}$ 或 $x > 1$

$f^{\prime}(x) < 0 \Leftrightarrow -\frac{a}{2} < x < 1$ ，故 $f(x)$ 在 $\left(-\infty, -\frac{a}{2}\right)$ 上单调递增，
...
则 $f^{\prime}(x) = \alpha (1 + x)^{\alpha -1} - \alpha = \alpha [(1 + x)^{\alpha -1} - 1]$
