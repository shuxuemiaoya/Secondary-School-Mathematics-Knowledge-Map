...
<span class="fake-tag">解析</span>由于 $AB$ 的长不变，所以分析 $S_{\triangle ABC}$ 的取值范围时，以 $AB$ 为底，研究高的范围即可，
...
<span class="fake-tag">解析</span>如图， $PO \perp$ 平面 $ABCD \Rightarrow PO \perp BD$ ，
...
<span class="fake-tag">解析</span>: 条件中有 $A_{1} P$ 的范围, $A_{1}$ 为定点, 故分析点 $P$ 的轨迹, 如图 1, 由于点 $P$ 在正方形 $A B C D$ 内, 所以把 $A_{1} P$ 向平面 $A B C D$ 投影, 到平面 $A B C D$ 上来分析,
...
<span class="fake-tag">解析</span>A项，要分析面面垂直，先找线面垂直，观察图形可猜想 $CD \perp$ 面PED，故尝试找理由，
...
<span class="fake-tag">解析</span>A项，如图，折起后的三棱锥中， $E$ ， $F$ 仍为 $AD$ ， $CD$ 的中点，所以 $EF / / AC$ ，从而 $EF / /$ 平面 $ABC$ ，故A项正确；
...
<span class="fake-tag">解析</span>A项，如图1，当 $M$ 为 $AC$ 中点时，结合 $P$ 为 $DD_{1}$ 中点可得 $PM \parallel BD_{1}$ ，由正方体的结构特征可知 $AB \neq BC_{1}$ ，所以四边形 $ABC_{1}D_{1}$ 不是菱形，从而 $BD_{1}$ 与 $AC_{1}$ 不垂直，
...
<span class="fake-tag">解析</span>研究球面与侧面 $BCC_{1}B_{1}$ 的交线属球的截面问题，故过球心作截面的垂线，找到截面圆圆心，
