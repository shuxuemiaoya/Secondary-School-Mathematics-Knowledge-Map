...
$\quad$C. $\left(\frac{1}{\mathrm{e}^2}, +\infty\right)$
...
<span class="fake-tag">解析</span>由题意，问题等价于存在直线 $y = b$ 与 $f(x)$ 的图象有3个交点，
...
<span class="fake-tag">解析</span>因为当 $x < a$ 时， $f(x) = -ax + 1$ 的单调性与 $a$ 的正负有关，所以由此讨论，画出 $f(x)$ 的图象，
...
<span class="fake-tag">答案</span>: 0 (答案不唯一, 见解析), 1
