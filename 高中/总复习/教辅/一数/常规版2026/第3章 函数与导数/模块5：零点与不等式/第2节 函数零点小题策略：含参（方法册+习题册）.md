...
<span class="fake-tag">答案</span> $(0,1)\cup (1, + \infty)$
...
<span class="fake-tag">解析</span>为了便于作图，考虑通过对方程 $f(x) = 0$ 等价变形，将其中的 $|x - a|$ 和 $e^x$ 分开，
...
<span class="fake-tag">答案</span> $[\mathrm{e}^{-2} - 2, - 1)$
...
<span class="fake-tag">解析</span>直接画 $f(x)$ 的图象不易，考虑将 $f(x) = 0$ 等价变形，以便于作图分析交点，由题意， $f(x) = 0 \Leftrightarrow x^2\mathrm{e}^{ax} - 1 = 0 \Leftrightarrow x^2\mathrm{e}^{ax} = 1 \Leftrightarrow x^2 = \mathrm{e}^{-ax}$ ，
...
<span class="fake-tag">答案</span> $\pm \frac{2}{\mathrm{e}}$ 或0
...
$\quad$B. $\left(-\frac{1}{e},0\right)$

$\quad$C. $(-\infty, -\mathrm{e})$

$\quad$D. $\left(-\infty, -\frac{1}{\mathrm{e}}\right)$
...
$\quad$C. $\left(\frac{\ln 2}{2},\frac{1}{\mathrm{e}}\right)$
