...
因为 $f'(x_{1}) = f'\left(-\frac{3}{2}\right) = \frac{23}{4},\quad f(x_{1}) = f\left(-\frac{3}{2}\right) = -\frac{7}{8},$
...
则 $g'(x) = \frac{\left[2 - \left(2x\ln x + x^{2} \cdot \frac{1}{x}\right)\right](x + 1) - (2x - x^{2}\ln x)}{(x + 1)^{2}}$
...
(影响 $h'(x)$ 正负的只有 $x - a$ 这一项, 它有零点 $a$ , 但 $a$ 不一定在定义域内, 故据此讨论)
...
所以 $f'(x) > 0$ ，故 $f(x)$ 在 $(1, + \infty)$ 上单调递增，
...
且 $f'(x) > 0\Leftrightarrow 0 <   x <   x_{1}$ 或 $x > x_{2}$ ， $f'(x) <   0\Leftrightarrow x_{1} <   x <   x_{2}$
...
则 $g'(x) = \frac{-4x(1 + x^{2}) - 2x\cdot 2(1 - x^{2})}{(1 + x^{2})^{2}} +\frac{2}{x} -1 - \frac{1}{x^{2}}$
...
且 $f'(x) = \frac{(x - 1)\mathrm{e}^{x}}{x^{2}} -\frac{1}{x} +1 = \frac{(x - 1)(\mathrm{e}^{x} + x)}{x^{2}},$
...
则 $F'(x) = f'(x) - f'\left(\frac{1}{x}\right)\cdot \left(-\frac{1}{x^{2}}\right) = f'(x) + \frac{1}{x^{2}} f'\left(\frac{1}{x}\right)$
...
所以 $f'(x) > 0\Leftrightarrow 0 <   x <   1$ ， $f'(x) <   0\Leftrightarrow x > 1$
...
设 $g(x) = f(x) - f(2 - x)$ ， $0 <   x <   1$ ，则 $g'(x) =$

$f ^ {'} (x) + f ^ {'} (2 - x) = - \ln x - \ln (2 - x) = - \ln [ 1 - (x - 1) ^ {2} ] > 0,$
...
记 $g(x) = \frac{x^2}{2} - x + \sin x$ ， $0 <   x <   \pi$ ，则 $g'(x) = x - 1 + \cos x$

(不易判断正负，考虑继续求导)

$g''(x) = 1 - \sin x \geq 0$ ，所以 $g'(x)$ 在 $(0, \pi)$ 上单调递增，

从而 $g'(x) > g'（0） = 0$ ，故 $g(x)$ 在 $(0,\pi)$ 上单调递增，
...
又 $f'（0） = a - 1 <   0$ ， $f'\left(\frac{\pi}{2}\right) = \frac{\pi}{2} -1 + a\cos \frac{\pi}{2} = \frac{\pi}{2} -1 > 0$
...
设 $f(x) = x - \sin x\left(0 <   x <   \frac{\pi}{2}\right)$ ，则 $f'(x) = 1 - \cos x > 0$
...
故 $g'(x) = \frac{1}{\cos^{2}x} + 2\cos x - 3 = \frac{1}{\cos^{2}x} + \cos x + \cos x - 3$
...
且 $a > 1$ ，所以 $\mathrm{e}^{1 - a} <   \mathrm{e}^0 = 1$ ，故 $f'（1） <   0$
...
设 $g(a) = \mathrm{e}^{1 - a} - 2a + 1$ ，则 $g'(a) = -\mathrm{e}^{1 - a} - 2 <   0$
...
则 $h'(a) = -\mathrm{e}^{-a} + 2$ ，所以 $h'(a) <   0\Leftrightarrow a <   - \ln 2$

$h'(a) > 0\Leftrightarrow -\ln 2 < a\leq 0$ ，从而 $h(a)$ 在 $(-\infty , - \ln 2)$ 上单调递
...
$u'(x) > 0\Leftrightarrow x > 1$ ，从而 $u(x)$ 在[0,1)上单调递减，在
...
从而应有 $f'（0）\geq 0$ ，由此可找到讨论的分界点）

由题意， $f'(x) = \mathrm{e}^{x} - a + \sin x$ ， $f''(x) = \mathrm{e}^x +\cos x$
...
所以 $f'(x)$ 在 $(0, + \infty)$ 上有且仅有1个零点 $x_0$
...
则 $g'(x) = \mathrm{e}^{x} + (x - 1)\mathrm{e}^{x} + \sin x + x\cos x - \sin x = xe^{x} + x\cos x$

$= x(\mathrm{e}^{x} + \cos x)$ ，因为 $x > 0$ ，所以 $\mathrm{e}^x +\cos x > 1 + \cos x\geq 0$

从而 $g'(x) > 0$ ，故 $g(x)$ 在 $(0, + \infty)$ 上单调递增，
...
设 $q(x) = \tan x - x$ ， $0 <   x\leq \frac{1}{2}$ ，则 $q'(x) = \left(\frac{\sin x}{\cos x}\right)' - 1$
