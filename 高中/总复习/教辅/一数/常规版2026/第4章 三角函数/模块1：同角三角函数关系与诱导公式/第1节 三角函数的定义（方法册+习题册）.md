...
<span class="fake-tag">解析</span>给出角 $\theta$ 终边上的一点，想到用三角函数的定义求出 $\sin \theta$ ，结合已知建立关于 $y$ 的方程，
...
<span class="fake-tag">解析</span> $P$ ， $Q$ 重合即射线 $OP$ 与 $OQ$ 重合，可看成角的终边重合，先把以 $OP$ ， $OQ$ 为终边的角写出来，
...
<span class="fake-tag">答案</span> $\left(\frac{1}{2},\frac{\sqrt{3}}{2}\right)$
