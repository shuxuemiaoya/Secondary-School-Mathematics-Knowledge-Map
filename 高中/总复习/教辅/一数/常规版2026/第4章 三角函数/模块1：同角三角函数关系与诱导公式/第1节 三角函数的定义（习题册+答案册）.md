...
<span class="fake-tag">解析</span>给出 $\alpha$ 终边上点 $P$ 的坐标，可由三角函数定义求出 $\cos \alpha$ ，从而建立方程解 $m$ ，再求 $\tan \alpha$
...
<span class="fake-tag">解析</span>要求 $\sin \alpha$ ，可考虑结合已知的 $\tan \alpha$ ，在 $\alpha$ 的终边上求一个点，用三角函数定义算 $\sin \alpha$ ，
...
<span class="fake-tag">解析</span>给出角的终边上的点的坐标，考虑用定义求该角的三角函数值，
...
<span class="fake-tag">解析</span>给出终边上一点，先把三角函数的定义式写出来，
