...
<span class="fake-tag">解析</span>几何中存在无数的二级结论，本节筛选出了一些在高考中比较常用的双曲线二级结论，记住这些结论可适当缩短解题时间.
...
<span class="fake-tag">解析</span>给出 $\angle F_{1}PF_{2}$ ，可由 $S = \frac{b^{2}}{\tan\frac{\theta}{2}}$ 求出 $\triangle PF_{1}F_{2}$ 的面积，再由 $S = c|y_{P}|$ 解出 $y_{P}$ ，
...
<span class="fake-tag">答案</span> $\pm \frac{\sqrt{3}}{2}$ ， $1 + \sqrt{5}$
...
$\quad$A. $a = \sqrt{3}$   
$\quad$B. 双曲线 $C$ 的渐近线方程为 $y = \pm \sqrt{3} x$   
$\quad$C. 若 $PF_{1} \perp PF_{2}$ , 则 $\triangle PF_{1}F_{2}$ 的面积为 2  
$\quad$D. 双曲线 $C$ 的离心率为 $\frac{\sqrt{10}}{3}$

<span class="fake-tag">解析</span>由对称性可得 $A$ ， $B$ 关于原点对称，又涉及斜率之积 $k_{PA}\cdot k_{PB}$ ，故想到第三定义斜率积结论，
...
<span class="fake-tag">解析</span>条件涉及弦中点，想到中点弦斜率积结论，
...
<span class="fake-tag">解析</span>涉及弦中点，想到中点弦斜率积结论，由题意， $k_{AB}\cdot k_{OP} = k_{AB}\cdot \frac{1}{m} = 1$ ，所以 $k_{AB} = m$
...
<span class="fake-tag">答案</span> $(0,1)\cup (\sqrt{2}, + \infty)$
