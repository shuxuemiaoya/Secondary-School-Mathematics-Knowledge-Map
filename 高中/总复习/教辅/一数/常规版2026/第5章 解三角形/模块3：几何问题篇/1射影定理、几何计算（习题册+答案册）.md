...
<span class="fake-tag">解析</span>看到 $b \cos C + c \cos B$ ，想到射影定理，将 $b \cos C +$
...
<span class="fake-tag">解析</span>建筑物的高度即为球的直径 $2 R$ ，不妨先画出过球心的截面，并标出已知条件，再分析，
...
<span class="fake-tag">解析</span>分析已知条件可发现诸多线段都与 $AB$ 有关系，先把 $AB$ 设成未知数，并表示其他线段，
