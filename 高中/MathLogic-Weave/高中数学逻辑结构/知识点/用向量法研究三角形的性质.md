...
如图1，在Rt△ABC中， $\angle C = 90^{\circ}$ .根据向量的加法法则，有
...
这个证明仅仅用到了“三角形回路（向量加法）”和数量积运算，而且证明过程是程序化的，充分体现了向量运算的作用，确实简单多了。<center><img src="MathLogic%20Weave/高中数学逻辑结构/知识点/Attachments/03b07623a3cd811e3c1db99fd974296c9db640a94b799de350333aeb48ef924c.jpg" style="max-width:100%;"></center><center>图1</center>
...
如图2，在△ABC中， $D$ ， $E$ ， $F$ 分别是 $BC$ ，CA，AB的中点，设BE，CF交于一点 $o$ ，连接 $AO$ ，OD.
...
$\overrightarrow {F B} = \overrightarrow {F O} + \overrightarrow {O B} = t _ {2} \overrightarrow {O C} + \overrightarrow {O B}.$<center><img src="MathLogic%20Weave/高中数学逻辑结构/知识点/Attachments/2c22d686e2a671a71e4e76665a105dcd966abb02bc2cb750c77d7523e4141f1d.jpg" style="max-width:100%;"></center><center>图2</center>
所以
$\begin{array}{l} \overrightarrow {B C} = \overrightarrow {A C} - \overrightarrow {A B} = 2 \overrightarrow {E C} - 2 \overrightarrow {F B} \\ = 2 \left(t _ {1} \overrightarrow {O B} + \overrightarrow {O C}\right) - 2 \left(t _ {2} \overrightarrow {O C} + \overrightarrow {O B}\right) \\ = 2 \left(t _ {1} - 1\right) \overrightarrow {O B} - 2 \left(t _ {2} - 1\right) \overrightarrow {O C}. \\ \end{array}$
...
$\begin{array}{l} \overrightarrow {O D} = \overrightarrow {B D} - \overrightarrow {B O} = \frac {1}{2} \overrightarrow {B C} + \overrightarrow {O B} \\ = \frac {1}{2} (\overrightarrow {O C} - \overrightarrow {O B}) + \overrightarrow {O B} = \frac {1}{2} (\overrightarrow {O C} + \overrightarrow {O B}). \\ \end{array}$
于是
...
<table><tr><td>4.结论的证明或否定</td></tr><tr><td>5.用向量方法探索几何图形性质的一般步骤</td></tr><tr><td>6.收获与体会</td></tr></table>