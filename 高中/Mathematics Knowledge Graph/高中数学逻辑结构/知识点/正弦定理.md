...
我们从熟悉的直角三角形的边、角关系的分析入手. [[直角三角形中的正弦定理]]
...
如图6.4-10，在锐角 $\triangle ABC$ 中，过点 $A$ 作与 $\overrightarrow{AC}$ 垂直的单位向量 $j$ ，则 $j$ 与 $\overrightarrow{AB}$ 的夹角为 $\frac{\pi}{2} - A$ ， $j$ 与 $\overrightarrow{CB}$ 的夹角为 $\frac{\pi}{2} - C$ .
...
由分配律，得
$j \cdot \overrightarrow {A C} + j \cdot \overrightarrow {C B} = j \cdot \overrightarrow {A B},$<center><img src="4440572ef1dd6df2fd487771dfeea0af02c730af7c6df8c4fdcf5b19a6f52dd6.jpg" style="max-width:100%;"></center><center>图6.4-10</center>
即
$| \boldsymbol {j} | | \overrightarrow {A C} | \cos \frac {\pi}{2} + | \boldsymbol {j} | | \overrightarrow {C B} | \cos \left(\frac {\pi}{2} - C\right) = | \boldsymbol {j} | | \overrightarrow {A B} | \cos \left(\frac {\pi}{2} - A\right),$
...
$\frac {a}{\sin A} = \frac {b}{\sin B} = \frac {c}{\sin C}.$<center><img src="3e534db18efd20345b289eeff4cbd267ab9b854bcfada7da37eba53d2c3c58b1.jpg" style="max-width:100%;"></center><center>图6.4-11</center>
...
> [!example]- 例7 在 $\triangle ABC$ 中，已知 $A = 15^{\circ}$ ， $B = 45^{\circ}$ ， $c = 3 + \sqrt{3}$ ，解这个三角形.
解：由三角形内角和定理，得
...
$\begin{array}{l} b = \frac {c \sin B}{\sin C} = \frac {(3 + \sqrt {3}) \sin 4 5 ^ {\circ}}{\sin 1 2 0 ^ {\circ}} \\ = \frac {(3 + \sqrt {3}) \times \frac {\sqrt {2}}{2}}{\frac {\sqrt {3}}{2}} = \sqrt {6} + \sqrt {2}. \\ \end{array}$
...
1. 完成下列解三角形问题（角度精确到 $1^{\circ}$ ，边长精确到 $1\mathrm{cm}$ ）：
（1）在 $\triangle ABC$ 中，已知 $A = 60^{\circ}$ ， $B = 45^{\circ}$ ， $c = 20~\mathrm{cm}$   
（2）在 $\triangle ABC$ 中，已知 $a = 20\mathrm{cm}$ ， $b = 11\mathrm{cm}$ ， $B = 30^{\circ}$
