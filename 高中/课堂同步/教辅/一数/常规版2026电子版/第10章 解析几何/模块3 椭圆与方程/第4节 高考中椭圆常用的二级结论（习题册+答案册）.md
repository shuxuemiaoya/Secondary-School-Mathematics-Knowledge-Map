...
解析：怎样翻译 $\angle F_{1}MF_{2} = 120^{\circ}$ ？可考虑对 $\triangle MF_{1}F_{2}$ 用余弦定理，需要 $\left|MF_1\right|$ 和 $\left|MF_2\right|$ ，它们分别是椭圆的左焦半径和右焦半径，可用 $M$ 的坐标代焦半径公式计算，而 $\left|OM\right|$ 恰好也可由 $M$ 的坐标计算，故设 $M$ 的坐标，
...
解析：涉及弦 $AB$ 的中点，考虑中点弦斜率积结论，先计算直线 $OM$ 和直线 $AB$ 的斜率，由题意， $k_{OM} = \frac{2 - 0}{-3 - 0} = -\frac{2}{3}$ ，
...
解析：看到 $PA, PB$ 的斜率积为 $-\frac{16}{25}, A, B$ 又关于原点对称，想到基于椭圆第三定义的斜率积结论，
...
解析：如图，由 $|PA| = |PB|$ 想到中垂线，故涉及弦中点，考虑中点弦斜率积结论，先设中点坐标，
