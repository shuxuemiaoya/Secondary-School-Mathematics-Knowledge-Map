...
解析：抛物线的焦点为 $F(1,0)\Rightarrow \frac{p}{2} = 1\Rightarrow p = 2$
...
解析：A 项， $\left|AF\right|=\left|AM\right|$ 怎样翻译？如图，可翻译成 A 在线段 FM 的中垂线上，从而得到 A 的横坐标，
