...
解析：看到 $x_{1}x_{2} + y_{1}y_{2}$ ，想到向量的数量积，由题意， $\overrightarrow{OP_1} = (x_1,y_1)$ ， $\overrightarrow{OP_2} = (x_2,y_2)$
...
解析：由对称性，不妨设 $M$ 在 $x$ 轴上方，有如图1和图2所示的两种情况，应先判断是哪种，
...
解析：翻译 $|CD|=\sqrt{2}|AB|$ 需要 $|AB|$ 和 $|CD|$ ，求 $|AB|$ 可用通径公式，而 $|CD|$ 可通过求C，D的坐标来算，由通径公式， $|AB|=\frac{2b^{2}}{a}$ ，由题意，直线l的方程为x=-c，代入 $y=-\frac{b}{a}x$ 解得： $y=\frac{bc}{a}$ ，
