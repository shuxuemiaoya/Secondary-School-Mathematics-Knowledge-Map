...
解析：如图，对称圆的圆心 $C'$ 与点 $C$ 关于 $l$ 对称，先求 $C'$ 的坐标，直线 $l$ 的斜率为 1，可按特殊情况处理，
...
所以 $C^{\prime}(-1,2)$ ，故所求圆的方程为 $(x + 1)^{2} + (y - 2)^{2} = 1$
...
所以 $M^{\prime}(-3, - 1)$ ，故 $\left|M'N\right| = \sqrt{(-3 - 1)^2 + (-1 - 1)^2} = 2\sqrt{5}$ ，即 $(|PM| + |PN|)_{\min} = 2\sqrt{5}$
...
所以 $A^{\prime}(-2, - 1)$ ，直线 $l_{2}$ 即为直线 $A'B$ ，其斜率为 $\frac{-1 - 2}{-2 - (-3)} = -3$
...
D. 若反射光线与圆 $C$ 的一个交点为 $A$ , 与 $x$ 轴交于点 $B$ , 则 $\vert PB \vert + \vert BA \vert$ 的最小值为 $2 \sqrt{3} - 1$