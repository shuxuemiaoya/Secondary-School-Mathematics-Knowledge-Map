...
解析：已知与所求有何关联？两式均涉及切和弦，不易直接看出关联，不妨先切化弦，再作对比，
...
解析：因为 $\sin \theta = k\cos \theta$ ，所以 $\tan \theta = k$
...
解析：因为 $\frac{\cos\alpha}{\cos\alpha - \sin\alpha} = \sqrt{3}$ ，所以上下同除以 $\cos \alpha$ 可得 $\frac{1}{1 - \tan\alpha} = \sqrt{3}$ ，解得： $\tan \alpha = 1 - \frac{\sqrt{3}}{3}$ ，
...
解析：因为 $\sin \alpha + 2\cos \alpha = 0$ ，所以 $\tan \alpha = \frac{\sin \alpha}{\cos \alpha} = -2$ ，
...
解析：看到 $\sin x + \cos x$ 和 $\sin x\cos x$ 出现在一个式子里，想
