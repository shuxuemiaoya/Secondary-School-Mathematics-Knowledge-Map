...
设 $f(x) = \frac{2 + \ln x}{x} (x > 0)$ ，则 $f^{\prime}(x) = -\frac{1 + \ln x}{x^{2}}$

所以 $f^{\prime}(x) > 0 \Leftrightarrow 0 < x < \mathrm{e}^{-1}$ , $f^{\prime}(x) < 0 \Leftrightarrow x > \mathrm{e}^{-1}$ ,
...
则 $g^{\prime}(x) = (x + 1)\mathrm{e}^{x} > 0$ ，所以 $g(x)$ 在(1,2)上
...
C. $\left[\frac{1}{\mathrm{e}}, 1\right) \cup (1, \mathrm{e})$

D. $\left\{\frac{1}{\mathrm{e}}\right\}$
...
设 $f(x) = x\ln x(x > 0)$ ，则 $f^{\prime}(x) = \ln x + 1$ 所以 $f^{\prime}(x) > 0\Leftrightarrow x > \frac{1}{\mathfrak{e}}$ ， $f^{\prime}(x) <   0\Leftrightarrow 0 <   x <   \frac{1}{\mathfrak{e}}$
