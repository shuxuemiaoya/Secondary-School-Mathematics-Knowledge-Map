...
（1） 把点 $P$ 的纵坐标 $y$ 叫做 $\alpha$ 的[正弦函数](课本/【人教版】高中必修%20第一册数学电子课本/知识点/概念/正弦函数.md)（sine function），记作 $\sin \alpha$ ，即
$$y = \sin \alpha ;$$
（2） 把点 $P$ 的横坐标 $x$ 叫做 $\alpha$ 的[余弦函数](课本/【人教版】高中必修%20第一册数学电子课本/知识点/概念/余弦函数.md)（cosine function），记作 $\cos \alpha$ ，即
$$x = \cos \alpha ;$$
（3）把点 $P$ 的纵坐标与横坐标的比值 $\frac{y}{x}$ 叫做 $\alpha$ 的[正切](课本/【人教版】高中必修%20第一册数学电子课本/知识点/概念/正切.md)，记作 $\tan \alpha$ ，即
$$\frac {y}{x} = \tan \alpha (x \neq 0).$$


可以看出，当 $\alpha = \frac{\pi}{2} + k\pi (k \in \mathbf{Z})$ 时， $\alpha$ 的终边在 $y$ 轴上，这时点 $P$ 的横坐标 $x$ 等于 0，所以 $\frac{y}{x} = \tan \alpha$ 无意义。除此之外，对于确定的角 $\alpha$ ， $\frac{y}{x}$ 的值也是唯一确定的。所以，$\frac{y}{x} = \tan \alpha (x \neq 0)$ 也是以角为自变量，以单位圆上点的纵坐标与横坐标的比值为函数值的函数，称为[正切函数](课本/【人教版】高中必修%20第一册数学电子课本/知识点/概念/正切函数.md)（tangent function）。


我们将正弦函数、余弦函数和正切函数统称为[三角函数](课本/【人教版】高中必修%20第一册数学电子课本/知识点/概念/三角函数.md)（trigonometric function），通常将它们记为：
