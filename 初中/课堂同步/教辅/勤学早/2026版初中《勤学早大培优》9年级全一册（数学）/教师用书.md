...
$\because AE \perp EF, \therefore \angle AEB + \angle FEH = 90^{\circ}. \because \angle AEB + \angle BAE = 90^{\circ},$

$\therefore \angle BAE = \angle FEH.\because \angle B = \angle H = 90^{\circ},\therefore \triangle ABE\sim \triangle EHF,$

$\therefore \frac{AB}{EH} = \frac{BE}{FH} = \frac{AE}{EF},\therefore \frac{k}{1 + x} = \frac{1}{x} = \frac{AE}{EF},\therefore x = \frac{1}{k - 1}.\therefore \frac{AE}{EF} = \frac{1}{x} = k - 1.$
...
则 AD=1, CE=2, ∵ $\angle BAC=60^{\circ}$ , $\angle ABC=90^{\circ}$ ,
...
![](images/bb55f19af8786c9cbad37eff54fd622627e8a7bb5ecd79ae921cad6a13e6c8aa.jpg)
...
解: 方法 1(外构): 过点 F 作 CF 的垂线, 交 BC 的延长线于点 M, 易得$\angle FCM = 30^{\circ}, \therefore CM = 2FM, CF = \sqrt{3} FM.$ 易证 $\triangle ABE \sim \triangle EMF,$
...
![](images/ee326424d19c5b86360195b78dc1fc01b110c80efea1f2f3c6d2297233a440d3.jpg)
...
(2) 过点 A 作 $AH \perp BC$ 于点 H，则 $BH = HE = \frac{1}{2} BE = \frac{1}{2} AB = 4, AH = \frac{\sqrt{3}}{2} AB = 4\sqrt{3}$ . $\because EF \perp BC, \therefore EF \parallel AH, \therefore \triangle CEF \sim \triangle CHA, \therefore \frac{CF}{CA} = \frac{CE}{CH} = \frac{1}{3}, \therefore CE = 2, \therefore AC = \sqrt{AH^{2} + HC^{2}} = 2\sqrt{21}$ .
...
设 AO=BO=x，则 OE=9-x，由 $BE^{2}+OE^{2}=OB^{2}$ ，得 $3^{2}+(9-x)^{2}=x^{2}$ ，解得 x=5，∴ FC=2x=10，
...
Geometric diagram showing a circle with points A, B, C, D, E, H and perpendicular lines, including dashed auxiliary lines.
</details>
...
$$
\begin{array}{l} \therefore \angle A C D = \angle B D C. \because A M \text {   是   } \odot O \text {   的直径,   弦   } B C \perp A M, \therefore B N = C N, \\ \therefore A M \text {   垂直平分   } B C, \therefore \angle A C D = \angle A B E, C E = B E, \therefore \angle B D C = \angle A B E, \\ \because \angle D E B = \angle B E F, \therefore \triangle F E B \sim \triangle B E D, \therefore \frac {E F}{B E} = \frac {B E}{D E}, \\ \therefore E F \cdot D E = B E ^ {2} = C E ^ {2}. \\ \end{array}
$$

证明: 连接 AC, BE, BD. $\because CD = AB, \therefore \widehat{ADB} = \widehat{DBC}, \therefore \widehat{AD} = \widehat{BC}$ ,
...
(2) $DE^{2}=DA\cdot DF$ . 理由如下: 连接 BE, ∵ E 是△ABC 的内心, ∴ $\angle ABE = \angle FBE$ , ∵ $\angle CBD = \angle CAD$

$$
= \angle B A D, \angle A D B = \angle B D F, \therefore \triangle A B D \sim \triangle B F D, \therefore \frac {D B}{D F} = \frac {D A}{D B}, \therefore D B ^ {2} = D A \cdot D F, \because \angle B E D = \angle B A D +
$$

$$
\angle A B E = \angle C B D + \angle F B E, \therefore \angle B E D = \angle D B E, \therefore D B = D E, \therefore D E ^ {2} = D A \cdot D F.
$$
...
∵矩形 ABCD 的面积是 8, ∴ $S_{\triangle ADC} = 4$ , ∵AC = 2AO, ∴ $S_{\triangle ADO} = 2$ , $S_{\triangle OCD} = 6$ ,
...
![](images/4898b2af4b3b7548074f1e5f0432f5abbed6a8627a17eda04a62dcbd4f64ae04.jpg)
...
Geometric diagram showing two intersecting lines with labeled points A, B, C and angle markings
</details>
...
$\therefore \triangle DEF \sim \triangle CAB$ , 同理: $\triangle D^{\prime}E^{\prime}F^{\prime} \sim \triangle C^{\prime}A^{\prime}B^{\prime}$ ,
...
![](images/7fb84523e999af932f83573da9e3eea158a926429919778c69e9962aaa080a07.jpg)
...
$\because AE=EF, \therefore ET$ 为 $\triangle AFA'$ 的中位线， $\therefore DE\parallel A'F;$
...
Geometric diagram of a square with labeled points and intersecting lines, including auxiliary constructions.
</details>
...
解: 延长 AB, DC 相交于点 E. ∵ $\angle ABC = \angle BCD = 135^{\circ}$ , ∴ $\angle EBC = \angle ECB = 45^{\circ}$ , ∴ BE = CE, $\angle E = 90^{\circ}$ . 设 BE = CE = x, 则 $BC = \sqrt{2}x$ , ∴ $AE = AB + BE = 9 + x$ , DE = CD + CE = 3 + x. 在 Rt△ADE 中, $\angle E = 90^{\circ}$ , ∴ $\tan A = \frac{DE}{AE} = \frac{3 + x}{9 + x} = \frac{1}{2}$ , ∴ x = 3, ∴ BC = $\sqrt{2}x = 3\sqrt{2}$ .
...
(2) 过点 D 作 $DG \perp BC$ 于点 G. 在 Rt△BDG 中, ∵ $\sin B = \frac{DG}{BD} = \frac{4}{5}$ , ∴ $DG = \frac{4}{5} \times 5 = 4$ . 在 Rt△DGF 中, ∵ $\tan \angle F = \frac{DG}{FG} = \frac{1}{2}$ , ∴ FG = 2DG = 8, ∴ $DF = \sqrt{DG^{2} + FG^{2}} = 4\sqrt{5}$ .
...
Geometric diagram with labeled points M, N, A, B, A' and dashed/solid lines forming triangles and a vertical structure
</details>
...
(2)如图2,在锐角△ABC中, $BE\perp AC$ 于点E, $CF\perp AB$ 于点F.求证: $\frac{S_{\triangle AEF}}{S_{\triangle ABC}}=\cos^{2}A$ ;   
...
![](images/724d19724ec3d0e70fc8e8fd6ccd1327ecca4bed647665c54269650d8e76c939.jpg)
...
![](images/4ee266e3a0a3de5ef77155d1d46931bdbda31225771e04d4ae735249fd3f009e.jpg)
...
![](images/43b326992a241dd29b4ef8e0b1934b592395735d3161feccd5bcf61ad994dffc.jpg)
...
=3,AH⊥BC,∴CH=BH.∵cos∠ABC= $\frac{1}{3}$ ,∴ $\frac{BH}{AB}=$ $\frac{1}{3},\therefore BH=1,\therefore CB=2HB=2,\therefore\triangle ABC$ 的周长为 8, $\therefore CD=8\div2-2=2$ ,故只需要以点 C 为圆心,CB 的长为半径画弧交 AC 于点 D,即为所求图形;
...
(2)由(1)得 $\angle BAN=\angle ABN=\angle C,\therefore AN=BN.\because \angle ADB=90^{\circ},\therefore\tan\angle ABD=\tan\angle C=\frac{AD}{BD}=\frac{2}{3}$ ,设 $AD=2a$ ,则 $BD=3a$ ,设 $DN=b$ ,则 $AN=BN=3a-b$ ,在 $Rt\triangle AND$ 中, $AD^{2}+DN^{2}=AN^{2},\therefore(2a)^{2}+b^{2}=(3a-b)^{2},\therefore a=\frac{6}{5}b$ ,在 $Rt\triangle AND$ 中, $\tan\angle CAF=\frac{DN}{AD}=b\times\frac{5}{12b}=\frac{5}{12}$ .
...
Geometric diagram showing a circle with points A, B, C, D, E, F, O and labeled segments and a dashed line NE
</details>
...
(2)连接 $AD, OC, OC$ 交 $BD$ 于点 $H$ . 易证 $OC \perp BD$ , $\therefore \angle O B H = \angle O C B$ ,
...
图2  
![](images/1d3defd94e054cb17dfe097a811bd2f262ea3743e1922a566b10cee7014af719.jpg)  
图3
...
即 $\cos \alpha = \frac{BD}{a}$ 所以 $BD = a\cos \alpha (\mathbf{m})$ 同理， $CD = a\sin \alpha (\mathbf{m})$
...
(2) 如图 1, $\because \mathrm{sad} A = \frac { B C } { A B } < \frac { A B + A C } { A B } = \frac { 2 A B } { A B } = 2 , \therefore 0 < \mathrm{sad} A < 2 ;$   
