...
（3）根据 $\frac{n+n+1}{n(n+1)}=\frac{1}{n}+\frac{1}{n+1}$ 先将括号内的式子变形为 $\left(\frac{1}{4}-\frac{1}{9}\right)$ ，再由 $121212=12\times10101$ ， $131313=13\times10101$ 进行求解即可.
...
$$
\begin{array}{l} \frac {1}{1 \times 3} + \frac {1}{3 \times 5} + \frac {1}{5 \times 7} + \frac {1}{7 \times 9} + \frac {1}{9 \times 1 1} + \frac {1}{1 1 \times 1 3} + \dots . + \frac {1}{9 7 \times 9 9} \\ = \frac {1}{2} \times \left(1 - \frac {1}{3} + \frac {1}{3} - \frac {1}{5} + \frac {1}{5} - \frac {1}{7} + \frac {1}{7} - \frac {1}{9} + \frac {1}{9} - \frac {1}{1 1} + \frac {1}{1 1} - \frac {1}{1 3} + \dots \dots + \frac {1}{9 5} - \frac {1}{9 7} + \frac {1}{9 7} - \frac {1}{9 9}\right) \\ = \frac {1}{2} \times \left(1 - \frac {1}{9 9}\right) \\ = \frac {1}{2} \times \frac {9 8}{9 9} \\ = \frac {4 9}{9 9} \\ \end{array}
$$
...
$5!=5\times4\times3\times2\times1$ ．正整数N的阶乘记作 $N!$ ，即 $N!=1\times2\times3\times\cdots\times N$ ．裂项相消法可以和阶乘结合起来研究，例如，我们可以把 $\frac{9}{10!}$ 拆分为两个分母含有阶乘形式的分子为1的分数的差，即 $\frac{9}{10!}=\frac{10-1}{10!}=\frac{10}{10!}-\frac{1}{10!}=\frac{1}{9!}-\frac{1}{10!}$
...
【详解】解： $-3.61 \times 0.75 + 0.61 \times \frac{3}{4} + (-0.2) \times 75\%$
...
![](images/63aff2333a919735c80dab171a321291d646b09876c0d4aafac2a87b102f8802_1.jpg)
...
![](images/7211527cb692e9010d636dca096362bf26431521b0c2e1e60075dcb2ccdbc86c_1.jpg)
...
![](images/5bc4bd598dcec55ab5d4ea4781df70c7c8a3c1168e78bda9ffb6437761294d14_1.jpg)
...
![](images/fca2772a51b333a80117e1f58c3df1365b8477f2c5bb125f46dc10f5cd506d5a_1.jpg)
...
![](images/eb366a4755cb910a08f3aa26318ba6642016285c8b1ed7d49be984dc7f9ac312_1.jpg)
...
![](images/c0d91010a00e25b697e2557a7700199a41b73f926bc20bdaa6656836fae44930_1.jpg)
...
![](images/1a1f18b90e9370fd823bd70a9bdaae3877b20c5574bf1d0f03c05ef877b6edea_1.jpg)
